...
public class Log4jColoredConsoleAppender extends ConsoleAppender {
   ...
   */
  private static final String FATAL_COLOUR = PREFIX + BRIGHT + SEPARATOR + FOREGROUND_MAGENTA
      + SUFFIX;
   ...
   */
  private static final String WARN_COLOUR = PREFIX + NORMAL + SEPARATOR + FOREGROUND_YELLOW
      + SUFFIX;
