 ...
 *
 * <p>
 * Before and after tasks are not part of dependencies, they are done in the
 * order given.
 *
...
public interface WorkbenchTask {
   ...
   *
   * <p>
   * If the task completes, it was successful. If it throws an exception,
   ...
   */
  void perform(WorkbenchTaskContext workbenchTaskContext) throws SmartSpacesException;
}
