...
import io.smartspaces.activity.binary.BasicNativeWebBrowserRunner;
import io.smartspaces.activity.binary.NativeWebBrowserRunner;
...
public class BasicWebBrowserActivityComponent extends BaseWebBrowserActivityComponent {
   ...
   *
   * TODO(keith): Should this actually depend on there being a web server? What
   * will break if the dependency is removed?
   */
  ...
  public boolean isComponentRunning() {
    // Either the web browser is running, or it was requested that the browser
    // not actually start up.
