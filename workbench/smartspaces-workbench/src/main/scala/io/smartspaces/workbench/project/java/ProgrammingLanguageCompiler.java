...
public interface ProgrammingLanguageCompiler {
	 ...
	 */
	String CONFIGURATION_BUILDER_JAVA_COMPILEFLAGS = "smartspaces.workbench.builder.java.compileflags";
	 ...
	 */
	void compile(ProjectTaskContext context, File compilationBuildDirectory, List<File> classpath,
