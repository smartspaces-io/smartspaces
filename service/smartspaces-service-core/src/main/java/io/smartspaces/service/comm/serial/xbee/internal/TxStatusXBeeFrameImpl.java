...
public class TxStatusXBeeFrameImpl implements TxStatusXBeeFrame {
  ...
  public TxStatusXBeeFrameImpl(int frameId, XBeeAddress16 address16, int transmitRetryCount,
   ...
   * 
   * @see
   * smartspaces.service.comm.serial.xbee.internal.ITxStatusXBeeFrame#
   * getFrameId()
   */
  @Override
  ...
  public String toString() {
    return "TxStatusXBeeFrameImpl [frameId=" + frameId + ", address16=" + address16
