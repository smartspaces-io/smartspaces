...
public interface SpaceControllerRepository extends TypedIdRepository {
   ...
   *          the typed ID
   *
   * @return the space controller with the given UUID or {@code null} if no such
   *         space controller
   *
   * @throws SmartSpacesException
   *           the type of the typed ID is unknown
   */
  SpaceController getSpaceControllerByTypedId(String typedIdString) throws SmartSpacesException;
   ...
   *
   * @return the new space controller configuration, it will not be saved in the
   *         repository
   */
   ...
   *
   * @return the new space controller configuration parameter, it will not be
