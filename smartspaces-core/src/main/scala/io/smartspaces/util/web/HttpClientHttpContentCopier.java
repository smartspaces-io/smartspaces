...
public class HttpClientHttpContentCopier implements HttpContentCopier {
  ...
  @Override
  public String getContentAsString(String sourceUri) throws SmartSpacesException {
    return getContentAsString(sourceUri, Charsets.UTF_8);
  }

  @Override
  public String getContentAsString(String sourceUri, Charset charset) throws SmartSpacesException {
