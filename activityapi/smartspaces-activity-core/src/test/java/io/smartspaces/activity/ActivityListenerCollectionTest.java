...
public class ActivityListenerCollectionTest {
  ...
  public void testCleanSend() {
    ...
    Mockito.verify(listener1, Mockito.times(1)).onActivityStatusChange(activity, oldStatus,
        newStatus);
    Mockito.verify(listener2, Mockito.times(1)).onActivityStatusChange(activity, oldStatus,
        newStatus);
  }
  ...
  public void testBrokenStartup() {
    ...
    Mockito.verify(listener2, Mockito.times(1)).onActivityStatusChange(activity, oldStatus,
        newStatus);
    Mockito.verify(listener3, Mockito.times(1)).onActivityStatusChange(activity, oldStatus,
        newStatus);
