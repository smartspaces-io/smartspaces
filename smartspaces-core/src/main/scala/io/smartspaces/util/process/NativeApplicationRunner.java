...
public interface NativeApplicationRunner extends ManagedResource, Restartable {
   ...
   *          a map of new environment variables to add, indexed by variable
   *          name
   *
   * @return this runner
   */
  ...
  /**
   * Parse a string of command line arguments. Arguments are separated by
   * whitespace. The character {@link #ESCAPE_CHARACTER} is used for the escape
   * character.
   *
   * <p>
   * The arguments will be supplied to the executable in the order added.
