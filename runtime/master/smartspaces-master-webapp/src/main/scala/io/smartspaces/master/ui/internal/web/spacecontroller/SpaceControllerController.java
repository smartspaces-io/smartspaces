...
public class SpaceControllerController extends BaseActiveSpaceMasterController {
  ...
  public @ResponseBody Map<String, ? extends Object> getSpaceControllerConfiguration(
  ...
  public @ResponseBody Map<String, ? extends Object> setSpaceControllerConfiguration(
      @PathVariable String id, @RequestBody Object config, HttpServletResponse response) {
  ...
  public @ResponseBody Map<String, ? extends Object> configureSpaceController(
      @PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object> modifySpaceControllerMetadata(
  ...
  public @ResponseBody Map<String, ? extends Object> disconnectSpaceController(
      @PathVariable String id) {
    return masterApiSpaceControllerManager.disconnectFromSpaceControllers(Collections
        .singletonList(id));
  }
  ...
  @RequestMapping(value = "/spacecontroller/{id}/cleanactivitiestmpdata.json",
      method = RequestMethod.GET)
  public @ResponseBody Map<String, ? extends Object>
      cleanActivitiesTempData(@PathVariable String id) {
  ...
  @RequestMapping(value = "/spacecontroller/{id}/cleanactivitiespermanentdata.json",
      method = RequestMethod.GET)
  public @ResponseBody Map<String, ? extends Object> cleanActivitiesPermanentData(
      @PathVariable String id) {
  ...
  @RequestMapping(value = "/spacecontroller/all/cleanactivitiestmpdata.json",
      method = RequestMethod.GET)
  ...
  @RequestMapping(value = "/spacecontroller/all/cleanpermanentdata.json",
      method = RequestMethod.GET)
  ...
  @RequestMapping(value = "/spacecontroller/all/cleanactivitiespermanentdata.json",
      method = RequestMethod.GET)
