...
package io.smartspaces.hardware.driver.gaming.wii;
...
public class WiiRemoteDriver extends DriverSupport {
  ...
  public void setLight(int light) {
    if (light >= 0 && light <= 3) {
      try {
        ...
        throw new SmartSpacesException("Error sending light command", e);
      }
    }
  }
  ...
  private void readCalibration() {
    try {
      ...
      throw new SmartSpacesException("Error sending read calibration command", e);
    }
  }
