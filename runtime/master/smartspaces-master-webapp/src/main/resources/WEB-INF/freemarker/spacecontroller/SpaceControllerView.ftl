...
<html>
<head>
<title>Smart Spaces Admin: Controllers</title>
...
function doAjaxCommand(command) {
  $.ajax({
      url: '/smartspaces/spacecontroller/${spacecontroller.id}/' + command + '.json',
...
<table class="commandBar">
  <tr>
    ...
    <td><button type="button" id="editButton" onclick="window.location='/smartspaces/spacecontroller/${spacecontroller.id}/edit.html'" title="Edit the application details">Edit</button></td>
    <td><button type="button" id="configButton" onclick="doAjaxCommand('configure')" title="Configure the space controller">Configure</button></td>
    <td><button type="button" id="editConfigButton" onclick="window.location='/smartspaces/spacecontroller/${spacecontroller.id}/config/edit.html'" title="Edit the space controller config">Edit Config</button></td>
    <td><button type="button" id="editMetadataButton" onclick="window.location='/smartspaces/spacecontroller/${spacecontroller.id}/metadata/edit.html'" title="Edit the space controller metadata">Metadata</button></td>
  ...
  <#list liveactivities as liveactivity>
    ...
    <tr class="${trCss}">
      <td class="liveactivity-name">
        <a class="uglylink" onclick="return ugly.changePage('/smartspaces/liveactivity/${liveactivity.id}/view.html', event);">${liveactivity.name?html}</a>
      </td>
      <td>
      ...
      <td>
        ...
        <span title="Live Activity is out of date" class="out-of-date-indicator">
          <img src="/smartspaces/static/img/outofdate.png" alt="Live Activity is out of date" />
        </span>
        </#if>
