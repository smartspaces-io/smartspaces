...
/**
 * Information about a project task and how it will be modified at runtime by
 * other tasks.
 *
...
public class WorkbenchTaskModifiers {
   ...
   */
  private List<WorkbenchTaskFactory> beforeTasks = new ArrayList<>();

  /**
   * The task factories for after tasks.
   */
  private List<WorkbenchTaskFactory> afterTasks = new ArrayList<>();
  ...
  public String toString() {
    return "ProjectTaskEntry [name=" + name + ", beforeTasks=" + beforeTasks + ", afterTasks="
        + afterTasks + "]";
  }
}
