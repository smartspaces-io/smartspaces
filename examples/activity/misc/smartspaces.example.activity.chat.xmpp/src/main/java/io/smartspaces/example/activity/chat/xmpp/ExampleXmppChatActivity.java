...
package io.smartspaces.example.activity.chat.xmpp;
...
import io.smartspaces.service.comm.chat.ChatService;
...
public class ExampleXmppChatActivity extends BaseActivity {
   ...
   */
  private static final String CONFIGURATION_PROPERTY_USERNAME =
      "activity.example.chat.xmpp.username";

  /**
   * Configuration property for getting the chat password.
   */
  private static final String CONFIGURATION_PROPERTY_PASSWORD =
      "activity.example.chat.xmpp.password";
  ...
  public void onActivitySetup() {
    ChatService chatService =
        getSpaceEnvironment().getServiceRegistry().getRequiredService(ChatService.SERVICE_NAME);
