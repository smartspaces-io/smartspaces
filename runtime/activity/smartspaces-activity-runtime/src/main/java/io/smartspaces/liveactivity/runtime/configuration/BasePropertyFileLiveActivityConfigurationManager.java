 ...
 */
public abstract class BasePropertyFileLiveActivityConfigurationManager implements
   ...
   */
  public BasePropertyFileLiveActivityConfigurationManager(
  ...
  @Override
  public StandardLiveActivityConfiguration newLiveActivityConfiguration(
      InstalledLiveActivity liveActivity, InternalLiveActivityFilesystem activityFilesystem) {
    ...
    File installedActivityConfiguration =
        getInstalledActivityConfiguration(liveActivity, activityFilesystem);
  ...
  /**
   * Indicate if an activity configuration is required for this instance.
   * Intended to be overridden by sub-classes to provide specific behavior for
   ...
   */
  private SingleConfigurationStorageManager newConfiguration(File configurationFile,
      boolean required, ExpressionEvaluator expressionEvaluator) {
    return new SimplePropertyFileSingleConfigurationStorageManager(required, configurationFile,
        expressionEvaluator);
  }
