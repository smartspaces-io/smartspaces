...
function doAjaxCommand(command) {
  $.ajax({
      url: '/smartspaces/liveactivity/${liveactivity.id}/' + command + '.json',
...
function deleteLiveActivity() {
    if (confirm("Are you sure you want to delete the live activity?")) {
        window.location='/smartspaces/liveactivity/${liveactivity.id}/delete.html'
    }
}
...
<table class="commandBar">
  ...
  <tr>
    <td><button type="button" id="editButton" onclick="ugly.changePage('/smartspaces/liveactivity/${liveactivity.id}/edit.html')" title="Edit the activity details">Edit</button></td>
    <td><button type="button" id="editConfigButton" onclick="ugly.changePage('/smartspaces/liveactivity/${liveactivity.id}/config/edit.html')" title="Edit the activity configuration">Edit Config</button></td>
    <td><button type="button" id="editMetadataButton" onclick="ugly.changePage('/smartspaces/liveactivity/${liveactivity.id}/metadata/edit.html')" title="Edit the live activity metadata">Metadata</button></td>
    <td><button type="button" id="cloneButton" onclick="ugly.changePage('/smartspaces/liveactivity/${liveactivity.id}/clone.html')" title="Clone the live activity">Clone</button></td>
...
<th>Activity</th>
<td>
  <a class="uglylink" onclick="return ugly.changePage('/smartspaces/activity/${liveactivity.activity.id}/view.html', event)">
...
<a class="uglylink" onclick="return ugly.changePage('/smartspaces/spacecontroller/${liveactivity.controller.id}/view.html', event);">${liveactivity.controller.name?html}</a>
<#else>
...
<span title="Live Activity is out of date" class="out-of-date-indicator"><img src="/smartspaces/static/img/outofdate.png" alt="Live Activity is out of date" /></span>
</#if>
...
<#list liveActivityGroups as liveActivityGroup>
    <li><a class="uglylink" onclick="return ugly.changePage('/smartspaces/liveactivitygroup/${liveActivityGroup.id}/view.html', event);">${liveActivityGroup.name?html}</a></li>
</#list>
</ul>
<#else>
<p>
