...
import io.smartspaces.service.comm.serial.xbee.TxRequestXBeeFrame;
...
public class TxRequestXBeeFrameImpl extends BaseRequestXBeeFrame implements TxRequestXBeeFrame {
   ...
   */
  public TxRequestXBeeFrameImpl(XBeeAddress64 address64, XBeeAddress16 address16, int frameNumber,
   ...
   *          options for the frame
   */
  public TxRequestXBeeFrameImpl(XBeeAddress64 address64, int frameNumber, int broadcastRadius,
      int options) {
    this(address64, XBeeAddress16Impl.BROADCAST_ADDRESS, frameNumber, broadcastRadius, options);
  }
}
