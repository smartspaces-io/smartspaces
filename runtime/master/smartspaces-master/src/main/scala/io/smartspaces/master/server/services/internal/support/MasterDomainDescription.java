...
public interface MasterDomainDescription {
   ...
   */
  String ELEMENT_NAME_DESCRIPTION_ROOT_ELEMENT = "smartspaces-master-domain-model";
  ...
  /**
   * The XML element name for the root element for a space controller
   * configuration's parameters.
   */
  String ELEMENT_NAME_SPACE_CONTROLLER_CONFIGURATION_ROOT_PARAMETERS =
      "space-controller-configuration-parameters";

  /**
   * The XML element name for an individual parameter element for a space
   * controller configuration's parameters.
   */
  String ELEMENT_NAME_SPACE_CONTROLLER_CONFIGURATION_INDIVIDUAL_PARAMETER = "parameter";

  /**
   * The XML attribute name for a space controller configuration's parameter
   * name.
   */
