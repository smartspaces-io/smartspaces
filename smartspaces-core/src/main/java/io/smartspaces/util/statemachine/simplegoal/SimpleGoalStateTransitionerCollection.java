...
package io.smartspaces.util.statemachine.simplegoal;
 ...
 * {@link SimpleGoalStateTransitioner.SimpleGoalStateTransitionResult.ERROR}
 * states.
 *
 * @param <S>
...
public class SimpleGoalStateTransitionerCollection<S, C> {
   ...
   *          the transitioner
   */
  public synchronized void addTransitioner(String transitionerKey,
      SimpleGoalStateTransitioner<S, C> transitioner) {
  ...
  public synchronized void transition(String transitionerKey, S newState) {
    ...
    if (transitioner != null) {
      ...
      if (result.equals(SimpleGoalStateTransitionResult.DONE)
          || result.equals(SimpleGoalStateTransitionResult.ERROR)) {
