...
/**
 * Spring Webflow handler for new installed activities.
 *
 * @author Keith M. Hughes
 */
public class NewLiveActivityFlowHandler extends AbstractFlowHandler {

  private static final String DEFAULT_URL = "/liveactivity/all.html";
