...
package io.smartspaces.example.activity.arduino.analog.trigger;
 ...
 * which reads an analog port and sends its value over a serial connection. Once
 * the value of the analog signal gets beyond a certain threshold, a trigger
 * will be set.
 * 
 * <p>
 ...
 */
public class TriggerArduinoAnalogActivity extends BaseRoutableActivity {
