...
public class ActivityController extends BaseActiveSpaceMasterController {
  ...
  public @ResponseBody Map<String, ? extends Object> getAllActivities(@RequestParam(
  ...
  public @ResponseBody Map<String, ? extends Object> viewActivityJson(@PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object>
      modifyLiveActivityMetadata(@PathVariable String id, @RequestBody Object metadataCommandObj,
