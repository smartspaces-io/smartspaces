...
package io.smartspaces.hardware.driver.proximity.sensacell;
...
public class SensacellDriver extends DriverSupport {
  ...
  private void update() {
    ...
    try {
      ...
      throw new SmartSpacesException("Could not update the sensacell values", e);
    }
  }
  ...
  public void drawToSensacell() {
    try {
      ...
      throw new SmartSpacesException("Cannot draw sensor data to sensacell", e);
    }
  }
  ...
  private int hexToInt(byte hexByte) {
    ...
    throw new SmartSpacesException(String.format("Illegal hex byte %d", (int) hexByte));
  }
  ...
  public void setSensorSpeed(int speed) {
    if (speed == SENSACELL_SPEED_10HZ || speed == SENSACELL_SPEED_20HZ) {
      ...
      try {
        ...
        throw new SmartSpacesException("Cannot set speed on SensacellDriver", e);
      }
    } else {
      // invalid speed value
    }
  ...
  public void setReadMode(int mode) {
    if (mode == SENSACELL_NORMAL_READ || mode == SENSACELL_LATCHED_READ) {
      ...
      try {
        ...
        throw new SmartSpacesException("Cannot set read mode on sensacell", e);
      }
      modeChanged = true;
    } else {
  ...
  public void setLatchMode(int latch) {
    if (latch == SENSACELL_MODE_READ_DIGITAL || latch == SENSACELL_MODE_READ_PROPORTIONAL) {
      ...
      try {
        ...
        throw new SmartSpacesException("Cannot set latch mode on SensacellDriver", e);
      }
    } else {
      // invalid latch value
    }
  ...
  public void systemReset() {
    try {
      ...
      throw new SmartSpacesException("Could not send system reset command to sensacell", e);
    }
  }
