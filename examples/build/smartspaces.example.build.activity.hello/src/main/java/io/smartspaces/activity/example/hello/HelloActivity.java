...
/**
 * A very simple Smart Spaces Java-based activity to demonstrate a task build.
 * The Foo class does not exist in the source and is created during a pre-build
 * task.
 *
