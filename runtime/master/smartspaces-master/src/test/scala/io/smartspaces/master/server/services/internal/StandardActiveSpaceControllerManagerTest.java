...
public class StandardActiveSpaceControllerManagerTest extends BaseSpaceTest {
  ...
  public void testCleanControllerPermanantData() {
    ...
    ActiveSpaceController acontroller =
        activeControllerManager.getActiveControllerByUuid(controllerUuid);
    Mockito.verify(remoteControllerClient).cleanSpaceControllerPermanentData(acontroller);
  }
  ...
  public void testCleanControllerPermanantDataAll() {
    ...
    ActiveSpaceController acontroller =
        activeControllerManager.getActiveControllerByUuid(controllerUuid);
    Mockito.verify(remoteControllerClient).cleanSpaceControllerActivitiesPermanentData(acontroller);
  }
  ...
  public void testCleanControllerTempData() {
    ...
    ActiveSpaceController acontroller =
        activeControllerManager.getActiveControllerByUuid(controllerUuid);
    Mockito.verify(remoteControllerClient).cleanSpaceControllerTempData(acontroller);
  }
  ...
  public void testCleanControllerTempDataAll() {
    ...
    ActiveSpaceController acontroller =
        activeControllerManager.getActiveControllerByUuid(controllerUuid);
    Mockito.verify(remoteControllerClient).cleanSpaceControllerActivitiesTempData(acontroller);
  }
  ...
  public void testActivityPermanentClean() {
    ...
    Mockito.verify(remoteControllerClient).cleanLiveActivityPermanentData(active);
  }
  ...
  public void testActivityTempClean() {
    ...
    Mockito.verify(remoteControllerClient).cleanLiveActivityTempData(active);
  }
  ...
  public void testActivityStartup() {
    ...
    Mockito.verify(remoteControllerClient, Mockito.times(1))
        .startupLiveActivity(activeLiveActivity);
  ...
  public void testActivityShutdown() {
    ...
    Mockito.verify(remoteControllerClient, Mockito.times(1)).shutdownLiveActivity(
        activeLiveActivity);
  }
  ...
  public void testActivityActivate() {
    ...
    Mockito.verify(remoteControllerClient, Mockito.times(1)).activateLiveActivity(
        activeLiveActivity);
  }
  ...
  public void testActivityDeactivate() {
    ...
    Mockito.verify(remoteControllerClient, Mockito.times(1)).deactivateLiveActivity(
        activeLiveActivity);
  }
  ...
  public void testActivityGroupStartup() {
    ...
    Mockito.verify(remoteControllerClient, Mockito.times(1)).startupLiveActivity(
        activeActivities.get(0));
    Mockito.verify(remoteControllerClient, Mockito.times(1)).startupLiveActivity(
        activeActivities.get(1));
  }
  ...
  public void testActivityGroupStartupWithFail() {
    ...
    Mockito.doThrow(new RuntimeException()).when(remoteControllerClient)
        .startupLiveActivity(activeActivities.get(0));
  ...
  public void testActivityGroupShutdownWithFail() {
    ...
    Mockito.doThrow(new RuntimeException()).when(remoteControllerClient)
        .shutdownLiveActivity(activeLiveActivities.get(0));
  ...
  public void testActivityGroupActivateWithFail() {
    ...
    Mockito.doThrow(new RuntimeException()).when(remoteControllerClient)
        .activateLiveActivity(activeLiveActivities.get(0));
  ...
  public void testActivityGroupDeactivateWithFail() {
    ...
    Mockito.doThrow(new RuntimeException()).when(remoteControllerClient)
        .deactivateLiveActivity(activeLiveActivities.get(0));
  ...
  public void testMultipleActivityGroupPartialStartup() {
    ...
    Mockito.verify(remoteControllerClient, Mockito.never()).startupLiveActivity(
        activeLiveActivities1.get(1));
  ...
  public void testMultipleActivityGroupPartialActivate() {
    ...
    Mockito.verify(remoteControllerClient, Mockito.never()).activateLiveActivity(
        activeLiveActivities1.get(1));
  ...
  public void testMultipleActivityGroupPartialDeactivate() {
    ...
    Mockito.verify(remoteControllerClient, Mockito.never()).deactivateLiveActivity(
        activeLiveActivities1.get(1));
  ...
  public void testEntireSpaceDeploy() {
    ...
    Space spaceTree =
        space(0).addSpaces(
            space(1, liveActivityGroup(activity13 = liveActivity(13)))
                .addSpaces(space(4), space(5)),
            space(2)
                .addSpaces(
                    space(
                        6,
                        liveActivityGroup(activity10 = liveActivity(10), activity11 =
                            liveActivity(11)))),
            space(3).addSpaces(space(7),
                space(8, liveActivityGroup(activity12 = liveActivity(12), activity10)), space(9)));
  ...
  public void testSubSpaceDeploy() {
    ...
    Space spaceTree =
        space(0).addSpaces(
            ...
            subspace =
                space(3).addSpaces(space(7),
                    space(8, liveActivityGroup(activity12 = liveActivity(12), activity10)),
                    space(9)));
  ...
  public void testEntireSpaceShutdown() {
    ...
    // Since space operations act on groups, we need to start before we can shut
    // down
    activeControllerManager.startupSpace(spaceTree);
  ...
  public void testSubSpaceShutdown() {
    ...
    Mockito.verify(remoteControllerClient, Mockito.times(1)).shutdownLiveActivity(
        activeControllerManager.getActiveLiveActivity(activity10));
    Mockito.verify(remoteControllerClient, Mockito.never()).shutdownLiveActivity(
        activeControllerManager.getActiveLiveActivity(activity11));
    Mockito.verify(remoteControllerClient, Mockito.times(1)).shutdownLiveActivity(
        activeControllerManager.getActiveLiveActivity(activity12));
    Mockito.verify(remoteControllerClient, Mockito.never()).shutdownLiveActivity(
  ...
  public void testEntireSpaceDeactivate() {
    ...
    // Since space operations act on groups, we need to activate before we can
    // deactivate
    activeControllerManager.activateSpace(spaceTree);
