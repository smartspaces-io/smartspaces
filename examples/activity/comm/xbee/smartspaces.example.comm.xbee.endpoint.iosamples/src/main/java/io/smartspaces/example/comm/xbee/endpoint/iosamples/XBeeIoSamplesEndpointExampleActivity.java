...
package io.smartspaces.example.comm.xbee.endpoint.iosamples;
...
/**
 * A Smart Spaces Java-based activity which sets up an XBee Radio for analog and
 * digital IO Sample transmission to the coordinator.
 *
 * <p>
...
public class XBeeIoSamplesEndpointExampleActivity extends BaseActivity {
  ...
  public void onActivityStartup() {
    getLog().info("Activity io.smartspaces.example.comm.xbee.endpoint.iosamples startup");
