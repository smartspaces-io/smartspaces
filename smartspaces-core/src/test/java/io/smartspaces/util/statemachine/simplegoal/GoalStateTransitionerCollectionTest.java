...
public class GoalStateTransitionerCollectionTest {
  ...
  public void testLeavesIfWorking() {
    ...
    Mockito.when(transitioner.transition(testState)).thenReturn(
        SimpleGoalStateTransitionResult.WORKING);
  ...
  public void testLeavesIfDone() {
    ...
    Mockito.when(transitioner.transition(testState)).thenReturn(
        SimpleGoalStateTransitionResult.DONE);
  ...
  public void testLeavesIfError() {
    ...
    Mockito.when(transitioner.transition(testState)).thenReturn(
        SimpleGoalStateTransitionResult.ERROR);
