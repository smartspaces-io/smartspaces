...
import io.smartspaces.workbench.ui.wizard.WizardCollection;
import io.smartspaces.workbench.ui.wizard.component.ChooseDirectoryWizard;
import io.smartspaces.workbench.ui.wizard.component.ChooseFileWizard;
...
public class NewProjectWizard extends WizardCollection {
   ...
   *          the workbench
   */
  public NewProjectWizard(WorkbenchUi workbenchUi, SmartSpacesWorkbench workbench) {
    ...
    addWizards(chooseDirectoryWizard, activityProjectTemplateChooserWizard,
        activityDescriptionWizard);
  }
  ...
  public void completeWizard() {
    ...
    context.setSpecificationBase(activityProjectTemplateChooserWizard.getSelectedFile()
        .getParentFile());
