...
import io.smartspaces.master.ui.internal.web.liveactivity.LiveActivityAction.LiveActivityForm;
...
public class LiveActivityValidator extends FormObjectValidator {
   ...
   *          the errors
   */
  private void validateLiveActivityPortion(LiveActivity liveActivity, String pathPrefix,
      Errors errors) {
