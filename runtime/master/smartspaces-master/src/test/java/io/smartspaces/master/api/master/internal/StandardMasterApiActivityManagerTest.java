...
public class StandardMasterApiActivityManagerTest {
  ...
  public void testManagerLifecycle() {
    ...
    Mockito.verify(masterEventManager).addListener(
        masterApiActivityManager.getMasterEventListener());

    masterApiActivityManager.shutdown();
    Mockito.verify(masterEventManager).removeListener(
        masterApiActivityManager.getMasterEventListener());
  }
  ...
  public void testActivityInstallSuccess() {
    ...
    masterApiActivityManager.getMasterEventListener().onLiveActivityDeploy(activeLiveActivity,
        result, timestamp);
  ...
  public void testLiveActivityEdit() {
    ...
    LiveActivity liveActivity = Mockito.mock(LiveActivity.class);
    Mockito.when(activityRepository.getLiveActivityByTypedId(liveActivityId)).thenReturn(
        liveActivity);
    ...
    Mockito.when(spaceControllerRepository.getSpaceControllerById(spaceControllerId)).thenReturn(
        spaceController);
