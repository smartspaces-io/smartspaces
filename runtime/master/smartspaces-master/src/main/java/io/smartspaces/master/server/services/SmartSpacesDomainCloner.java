...
/**
 * A cloner of Smart Spaces Activity objects.
 *
 * <p>
 * These classes are not guaranteed to be threadsafe, and should only be used
 * for a single cloning operation as they are not guaranteed to not contain
 * state.
 *
 * @author Keith M. Hughes
 */
public interface SmartSpacesDomainCloner {
  ...
  /**
   * Get the cloned live activity by the ID of the original live activity that
   * was cloned.
   *
   * @param srcId
  ...
  /**
   * Get the cloned live activity group by the ID of the original live activity
   * group that was cloned.
   *
   * @param srcId
