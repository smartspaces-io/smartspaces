...
/**
 * Simple standalone router that just loops messages back -- useful when no
 * other valid interface is available.
 *
...
public class LoopbackRouter implements StandaloneRouter {
  ...
  public MessageMap receive() {
    try {
      ...
      throw new SimpleSmartSpacesException("LoopbackRouter interrupted", e);
    }
  }
}
