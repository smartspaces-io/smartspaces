...
SET SMARTSPACES_SCRIPT="stop.bat"
if exist "%DIRNAME%setenv.bat" (
  call "%DIRNAME%setenv.bat"
)

rem Check console window title. Set to Smartspaces by default
if not "%SMARTSPACES_TITLE%" == "" (
    title %SMARTSPACES_TITLE%
) else (
    title Smartspaces
)
...
:EXECUTE
    "%SMARTSPACES_HOME%\bin\smartspaces.bat" stop
