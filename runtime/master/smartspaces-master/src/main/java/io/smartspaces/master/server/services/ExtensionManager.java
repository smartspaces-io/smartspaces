...
public interface ExtensionManager {
   ...
   */
  public static final String RESULT_KEY_SPACE_MASTER_EXTENSION_UNKNOWN =
      "space.master.extension.unknown";

  /**
   * Result key for extension exception.
   */
  public static final String RESULT_KEY_SPACE_MASTER_EXTENSION_EXCEPTION =
      "space.master.extension.exception";
   ...
   */
  Map<String, Object> evaluateApiExtension(String extensionName, Map<String, Object> args);
}
