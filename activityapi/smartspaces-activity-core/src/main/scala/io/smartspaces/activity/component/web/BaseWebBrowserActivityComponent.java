...
/**
 * Abstract base class for web browser activity components, providing for common
 * constants and base functionality. Needs to be overridden to provide an actual
 * implementation.
 *
...
public abstract class BaseWebBrowserActivityComponent extends BaseActivityComponent implements
  ...
  public void configureComponent(Configuration configuration) {
    ...
    if (isExternalPrefix(configurationInitialPage)) {
      ...
      initialUrlBuilder.append(webServer.getWebContentUrl())
