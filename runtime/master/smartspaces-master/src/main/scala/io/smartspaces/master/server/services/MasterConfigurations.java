...
public class MasterConfigurations {
  ...
  /**
   * The configuration parameter that gives the name of the space. Used to paint
   * the Master webapp.
   */
  public static final String CONFIGURATION_NAME_SPACE_NAME = "smartspaces.name";
