...
public class Jsr82BluetoothCommunicationEndpointService extends BaseSupportedService implements
  ...
  public BluetoothDevice getLocalBluetoothInformation() {
    try {
      ...
      throw new SmartSpacesException("Could not obtain local bluetooth information", e);
    }
  }
  ...
  public List<BluetoothDevice> discoverRemoteDevices() {
    ...
    try {
          ...
          switch (discType) {
            ...
            default:
              ...
              getSpaceEnvironment().getLog().warn(
                  "Bluetooth discover inquiry unknown response code");
      ...
      throw new SmartSpacesException("Error during bluetooth discovery", e);
    }
  }
