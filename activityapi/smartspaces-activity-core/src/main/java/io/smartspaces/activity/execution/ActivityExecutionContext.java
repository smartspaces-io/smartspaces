...
package io.smartspaces.activity.execution;
...
public interface ActivityExecutionContext {
  ...
  /**
   * Get an activity runnable that will handle method invocation properly for
  ...
  /**
   * Get an activity callable that will handle method invocation properly for
