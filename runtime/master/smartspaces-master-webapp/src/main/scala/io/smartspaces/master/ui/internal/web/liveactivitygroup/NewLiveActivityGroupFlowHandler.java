...
/**
 * Spring Webflow handler for new activity groups.
 *
 * @author Keith M. Hughes
 */
public class NewLiveActivityGroupFlowHandler extends AbstractFlowHandler {

  private static final String DEFAULT_URL = "/liveactivitygroup/all.html";
