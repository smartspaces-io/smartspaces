...
public class LiveActivityGroupController extends BaseActiveSpaceMasterController {
  ...
  public @ResponseBody Map<String, ? extends Object> viewActivityGroupJson(@PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object> statusActivityGroup(@PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object> deployActivityGroup(@PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object>
      configureActivityGroup(@PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object> startupActivityGroup(@PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object> activateActivityGroup(@PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object>
      deactivateActivityGroup(@PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object> shutdownLiveActivityGroup(
  ...
  @RequestMapping(value = "/liveactivitygroup/{id}/forceshutdownliveactivities.json",
      method = RequestMethod.GET)
  public @ResponseBody Map<String, ? extends Object> forceShutdownLiveActivityLiveActivityGroup(
      @PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object> modifyLiveActivityGroupMetadata(
  ...
  public @ResponseBody Map<String, ? extends Object> listAllGroupsJson(@RequestParam(
