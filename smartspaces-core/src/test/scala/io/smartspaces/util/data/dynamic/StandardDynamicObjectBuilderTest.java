...
/**
 * Tests for the {@link StandardDynamicObjectBuilder}.
 *
 * @author Keith M. Hughes
 */
public class StandardDynamicObjectBuilderTest {

  private StandardDynamicObjectBuilder builder;

  @Before
  public void setup() {
    builder = new StandardDynamicObjectBuilder();
  }
  ...
  public void testPrimitives() {
    ...
    builder.setProperty(keyString1, valueString1);

    String keyString2 = "string1";
    String valueString2 = "bar";
    builder.setProperty(keyString2, valueString2);

    String keyInteger = "integer";
    int valueInteger = 1;
    builder.setProperty(keyInteger, valueInteger);

    String keyDouble = "double";
    double valueDouble = 1.23456;
    builder.setProperty(keyDouble, valueDouble);
  ...
  public void testNestedObjects() {
    ...
    builder.setProperty(key, value0);
