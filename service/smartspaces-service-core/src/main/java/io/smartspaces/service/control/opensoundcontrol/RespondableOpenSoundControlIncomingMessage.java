...
public interface RespondableOpenSoundControlIncomingMessage extends OpenSoundControlIncomingMessage {
  ...
  /**
   * Create a new OSC message that is a reply to the current message and
   * immediately send it.
   *
   * <p>
  ...
  /**
   * Create a new OSC message that is a reply to the current message by
   * specifying all argument types.
   *
   * <p>
