...
public class SpaceController extends BaseActiveSpaceMasterController {
  ...
  public @ResponseBody Map<String, ? extends Object> viewSpaceJson(@PathVariable String id) {
    return masterApiActivityManager.getSpaceView(id);
  }

  @RequestMapping(value = "/space/{id}/status.json", method = RequestMethod.GET)
  public @ResponseBody Map<String, ? extends Object> statusSpaceJson(@PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object> modifySpaceGroupMetadata(
  ...
  public @ResponseBody Map<String, ? extends Object> deploySpace(@PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object> configureSpace(@PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object> startupSpace(@PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object> activateSpace(@PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object> deactivateSpace(@PathVariable String id) {
  ...
  public @ResponseBody Map<String, ? extends Object> shutdownSpace(@PathVariable String id) {
