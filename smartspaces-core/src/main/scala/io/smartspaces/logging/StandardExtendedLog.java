...
package io.smartspaces.logging;
...
public class StandardExtendedLog implements ExtendedLog {
  ...
  public void formatTrace(Throwable throwable, String message, Object... args) {
    ...
    if (throwable != null) {
      delegate.trace(SmartSpacesExceptionUtils.getExceptionDetail(throwable));
    }
  }
  ...
  public void formatDebug(Throwable throwable, String message, Object... args) {
    ...
    if (throwable != null) {
      delegate.debug(SmartSpacesExceptionUtils.getExceptionDetail(throwable));
    }
  }
  ...
  public void formatInfo(Throwable throwable, String message, Object... args) {
    ...
    if (throwable != null) {
      delegate.info(SmartSpacesExceptionUtils.getExceptionDetail(throwable));
    }
  }
  ...
  public void formatWarn(Throwable throwable, String message, Object... args) {
    ...
    if (throwable != null) {
      delegate.warn(SmartSpacesExceptionUtils.getExceptionDetail(throwable));
    }
  }
  ...
  public void formatError(Throwable throwable, String message, Object... args) {
    ...
    if (throwable != null) {
      delegate.error(SmartSpacesExceptionUtils.getExceptionDetail(throwable));
    }
  }
