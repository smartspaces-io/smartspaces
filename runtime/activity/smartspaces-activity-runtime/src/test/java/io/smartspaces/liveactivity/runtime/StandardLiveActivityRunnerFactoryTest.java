...
public class StandardLiveActivityRunnerFactoryTest {
  ...
  public void registerUnversionedType() {
    ...
    Mockito.when(
        wrapperFactory.newActivityWrapper(liveActivity, filesystem, configuration,
            liveActivityRuntime)).thenReturn(wrapper);

    runnerFactory.registerActivityWrapperFactory(wrapperFactory);

    LiveActivityRunner aactivity =
        runnerFactory.newLiveActivityRunner("foo", liveActivity, filesystem, configuration,
            runnerListener, liveActivityRuntime);
  ...
  public void getHighestVersion() {
    ...
    Mockito.when(
        unversionedWrapperFactory.newActivityWrapper(liveActivity, filesystem, configuration,
            liveActivityRuntime)).thenReturn(unversionedWrapper);
    ...
    Mockito.when(
        versionedWrapperFactory.newActivityWrapper(liveActivity, filesystem, configuration,
            liveActivityRuntime)).thenReturn(versionedWrapper);
  ...
  public void getExactVersion() {
    ...
    LiveActivityRunner aactivity =
        runnerFactory.newLiveActivityRunner("foo;=0.0.0", liveActivity, filesystem, configuration,
            runnerListener, liveActivityRuntime);
  ...
  public void getRangeVersion() {
    ...
    Mockito.when(
        version1WrapperFactory.newActivityWrapper(liveActivity, filesystem, configuration,
            liveActivityRuntime)).thenReturn(version1Wrapper);
    ...
    Mockito.when(
        version2WrapperFactory.newActivityWrapper(liveActivity, filesystem, configuration,
            liveActivityRuntime)).thenReturn(version2Wrapper);

    runnerFactory.registerActivityWrapperFactory(version2WrapperFactory);

    LiveActivityRunner aactivity =
        runnerFactory.newLiveActivityRunner("foo;[1.1, 1.3)", liveActivity, filesystem,
            configuration, runnerListener, liveActivityRuntime);
  ...
  public void askForVersionTooHigh() {
    ...
    try {
      runnerFactory.newLiveActivityRunner("foo;[5, 6)", liveActivity, filesystem, configuration,
          runnerListener, liveActivityRuntime);
