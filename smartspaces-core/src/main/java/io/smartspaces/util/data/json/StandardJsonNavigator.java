...
public class StandardJsonNavigator implements JsonNavigator {
  ...
  public StandardJsonNavigator(Object root) {
    if (root instanceof Map) {
      ...
      throw new JsonSmartSpacesException("Non object JSON data not supported");
    }
  }
  ...
  public String getString(String name) {
    if (currentType == JsonType.OBJECT) {
      ...
      throw new JsonSmartSpacesException(String.format("Current level is not a object for name %s",
          name));
    }
  }
  ...
  public Double getDouble(String name) {
    if (currentType == JsonType.OBJECT) {
      ...
      if (Double.class.isInstance(value)) {
        ...
        throw new JsonSmartSpacesException(String.format("Object field %s is not numeric", name));
      }
    } else {
      throw new JsonSmartSpacesException(String.format("Current level is not a object for name %s",
          name));
  ...
  public Set<String> getProperties() {
    if (currentType == JsonType.OBJECT) {
      ...
      throw new JsonSmartSpacesException("Current level is not a object");
    }
  }
  ...
  @Override
  public String getString(int pos) throws JsonSmartSpacesException {
    if (currentType == JsonType.ARRAY) {
      String value = (String) currentArray.get(pos);
      return value;
    } else {
      throw new JsonSmartSpacesException(String.format(
          "Current level is not a array for position %d", pos));
    }
  }

  @Override
  public Integer getInteger(int pos) throws JsonSmartSpacesException {
    if (currentType == JsonType.ARRAY) {
  ...
  @Override
  public Double getDouble(int pos) throws JsonSmartSpacesException {
    if (currentType == JsonType.ARRAY) {
      ...
      if (Double.class.isInstance(value)) {
        ...
        throw new JsonSmartSpacesException(String.format("Array field %d is not numeric", pos));
      }
    } else {
      throw new JsonSmartSpacesException(String.format(
          "Current level is not a array for position %d", pos));
  ...
  @Override
  public Boolean getBoolean(int pos) throws JsonSmartSpacesException {
    if (currentType == JsonType.ARRAY) {
  ...
  @Override
  public <T> T getItem(int pos) throws JsonSmartSpacesException {
    if (currentType == JsonType.ARRAY) {
  ...
  @Override
  public int getSize() throws JsonSmartSpacesException {
    if (currentType == JsonType.ARRAY) {
      return currentArraySize;
    } else {
      throw new JsonSmartSpacesException("Current level is not array");
    }
  }

  @Override
  public Map<String, Object> getCurrentItem() throws JsonSmartSpacesException {
    if (currentType == JsonType.OBJECT) {
  ...
  @Override
  public JsonNavigator down(int pos) throws JsonSmartSpacesException {
    if (currentType == JsonType.ARRAY) {
      Object value = currentArray.get(pos);
  ...
  public JsonNavigator up() {
    if (!nav.isEmpty()) {
      ...
      throw new JsonSmartSpacesException("Could not go up, was at root");
    }
  }
  ...
  public Object traversePath(String path) {
    ...
    for (int i = 0; i < elements.length; i++) {
      ...
      if (element.isEmpty()) {
        throw new JsonSmartSpacesException(String.format("Empty element in path %s", path));
      }
      ...
      if (element.equals("$")) {
        ...
        if (curObject instanceof List) {
          if (element.endsWith("]")) {
            ...
            throw new JsonSmartSpacesException(String.format("Path element %s does not end in a ]",
                element));
          }
        } else if (curObject instanceof Map) {
          throw new JsonSmartSpacesException("Attempt to use an array index in an object");
        } else if (i < elements.length) {
          throw new JsonSmartSpacesException("Non array or object in the middle of a path");
        }
      } else {
        // Have a result name
        if (curObject instanceof Map) {
          ...
          throw new JsonSmartSpacesException("Attempt to use an name index in an array");
        } else if (i < elements.length) {
          throw new JsonSmartSpacesException("Non array or object in the middle of a path");
        }
      }
   ...
   */
  private <T> T checkedValue(Object value, String name) throws SimpleSmartSpacesException {
  ...
  private <T> T checkedValue(Object value, String format, int index)
    ...
    try {
      ...
      throw new JsonSmartSpacesException(String.format(format, index), e);
    }
  }
}
