 ...
 *
 * <p>
 * It is only necessary to check failure of startup here as operations other
 * than the actual activity itself can fail, such as the loading of the
 * activity.
 *
...
public class StandardLiveActivityRunnerTest {
  ...
  public void setup() {
    ...
    runner =
        new StandardLiveActivityRunner(installedActivity, activityWrapper, activityFilesystem,
            configuration, liveActivityRunnerListener, liveActivityRuntime);
  }
