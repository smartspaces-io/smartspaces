...
public class TimeDelay {
   ...
   * @return the delay
   */
  public static TimeDelay seconds(double seconds) {
    return new TimeDelay((long) (ONE_SECOND_IN_MILLISECONDS * seconds), TimeUnit.MILLISECONDS);
  }
   ...
   * @return the delay
   */
  public static TimeDelay minutes(double minutes) {
    return new TimeDelay((long) (ONE_MINUTE_IN_MILLISECONDS * minutes), TimeUnit.MILLISECONDS);
  }
   ...
   */
  public TimeDelay(long delay, TimeUnit unit) {
    this.delay = delay;
    this.unit = unit;
  }
