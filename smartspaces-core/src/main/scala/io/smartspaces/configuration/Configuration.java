...
public interface Configuration {
   ...
   *
   * @return {@code true} if the configuration has the property, {@code false}
   *         otherwise
   */
   ...
   */
  String getRequiredPropertyString(String property) throws SmartSpacesException;
   ...
   *           if the property does not exist
   */
  Integer getRequiredPropertyInteger(String property) throws SmartSpacesException;
   ...
   *           if the property does not exist
   */
  Long getRequiredPropertyLong(String property) throws SmartSpacesException;
   ...
   *           if the property does not exist
   */
  Double getRequiredPropertyDouble(String property) throws SmartSpacesException;
   ...
   *           if the property does not exist
   */
  Boolean getRequiredPropertyBoolean(String property) throws SmartSpacesException;
