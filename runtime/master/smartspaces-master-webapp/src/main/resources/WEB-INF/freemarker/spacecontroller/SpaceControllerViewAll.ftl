...
<html>
<head>
<title>Smart Spaces Admin: Space Controllers</title>
...
function doAjaxCommand(command) {
  $.ajax({
      url: '/smartspaces/spacecontroller/all/' + command + '.json',
...
function shutdownAllControllers() {
    if (confirm("Are you sure you want to shutdown all controllers?")) {
        window.location='/smartspaces/spacecontroller/all/shutdown.html';
    }
}
...
<table class="commandBar">
  <tr>
    ...
    <td><button type="button" id="newButton" onclick="window.location='/smartspaces/spacecontroller/new.html?mode=embedded'" title="Create a new controller">New</button></td>
  <tr>
  </tr>
    <td><button type="button" id="disconnectAllButton" onclick="window.location='/smartspaces/spacecontroller/all/disconnect.html'" title="Disconnect from all known controllers">Disconnect All</button></td>
  ...
  <#list spacecontrollers as spacecontroller>
    ...
    <tr class="${trCss}">
      <td class="controller-name">
        <a class="uglylink" onclick="return ugly.changePage('/smartspaces/spacecontroller/${spacecontroller.id}/view.html', event);">${spacecontroller.name?html}</a>
      </td>
      <td class="mode-value">
