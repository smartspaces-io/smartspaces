...
<html>
<head>
<title>Smart Spaces Admin: Activities</title>
...
function doAjaxCommand(command) {
  $.ajax({
      url: '/smartspaces/activity/${activity.id}/' + command + '.json',
...
function deleteActivity() {
    if (confirm("Are you sure you want to delete the activity?")) {
        window.location='/smartspaces/activity/${activity.id}/delete.html'
    }
}
</script>
...
<table class="commandBar">
  <tr>
    ...
    <td><button type="button" id="editButton" onclick="window.location='/smartspaces/activity/${activity.id}/edit.html'" title="Edit the activity details">Edit</button></td>
    <td><button type="button" id="editMetadataButton" onclick="window.location='/smartspaces/activity/${activity.id}/metadata/edit.html'" title="Edit the activity metadata">Metadata</button></td>
