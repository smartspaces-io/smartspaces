...
package io.smartspaces.liveactivity.runtime.activity.wrapper.internal.web;
 ...
 */
public class WebActivityWrapper extends BaseActivityWrapper {

  @Override
  public Activity newInstance() {
    return new BaseWebActivity();
  }
}
