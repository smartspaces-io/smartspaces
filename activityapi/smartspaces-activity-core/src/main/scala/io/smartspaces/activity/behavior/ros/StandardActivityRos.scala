 ...
 *
 * <p>
 * This behavior uses the registered {@link RosActivityComponent.COMPONENT_NAME} activity component.
 *
 * @author Keith M. Hughes
 */
trait StandardActivityRos extends RosActivityBehavior {

  /**
   * The ROS activity component.
   */
  private var rosActivityComponent: RosActivityComponent = null
  ...
  override def getRosEnvironment(): RosEnvironment = {
    return rosActivityComponent.getRosEnvironment
  }

  override def getMainNode(): ConnectedNode = {
