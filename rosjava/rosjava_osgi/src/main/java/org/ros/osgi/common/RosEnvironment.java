...
public interface RosEnvironment {
  ...
  /**
   * Create a node from the given node configuration with the given set of node
   * listeners.
   *
   * @param configuration
   *          the configuration describing the node
   ...
   * @return a newly created node.
   */
  ConnectedNode newNode(NodeConfiguration nodeConfiguration, Collection<NodeListener> listeners);
   ...
   *
   * <p>
   * All {@link NodeConfiguration} instances returned by this instance will have
   * this master URI.
   *
