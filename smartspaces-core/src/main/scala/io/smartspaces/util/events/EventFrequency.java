...
package io.smartspaces.util.events;
...
public class EventFrequency {
  ...
  public static EventFrequency eventsPerSecond(double eventsPerSecond) {
    return new EventFrequency((long) (ONE_SECOND_IN_MILLISECONDS / eventsPerSecond),
  ...
  public static EventFrequency eventsPerMinute(double eventsPerMinute) {
    return new EventFrequency((long) (ONE_MINUTE_IN_MILLISECONDS / eventsPerMinute),
        TimeUnit.MILLISECONDS);
  }
