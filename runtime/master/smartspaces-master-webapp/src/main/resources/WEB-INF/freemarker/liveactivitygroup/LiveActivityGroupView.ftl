...
<html>
<head>
<title>Smart Spaces Admin: Live Activity Groups</title>

<#include "/allpages_head.ftl">

<script type="text/javascript" src="/smartspaces/js/jquery-sspopup.js"></script>

<script type="text/javascript">
$(document).ready(function() {
<#list liveactivities as liveactivity>
$('${"#liveactivity-info-${liveactivity.uuid}"}')
  .sspopup("#liveactivity-info-${liveactivity.uuid}-popup");
</#list>
});
</script>
</head>
...
function doAjaxCommand(command) {
  $.ajax({
      url: '/smartspaces/liveactivitygroup/${liveactivitygroup.id}/' + command + '.json',
...
function deleteActivityGroup() {
    if (confirm("Are you sure you want to delete the live activity group?")) {
        window.location='/smartspaces/liveactivitygroup/${liveactivitygroup.id}/delete.html'
    }
}
</script>
...
<table class="commandBar">
  ...
  <tr>
    <td><button type="button" id="editButton" onclick="window.location='/smartspaces/liveactivitygroup/${liveactivitygroup.id}/edit.html'" title="Edit the live activity group details">Edit</button></td>
    <td><button type="button" id="editMetadataButton" onclick="window.location='/smartspaces/liveactivitygroup/${liveactivitygroup.id}/metadata/edit.html'" title="Edit the live activity group metadata">Metadata</button></td>
   <td><button type="button" id="cloneButton" onclick="window.location='/smartspaces/liveactivitygroup/${liveactivitygroup.id}/clone.html'" title="Clone the live activity group">Clone</button></td>
...
<li><a class="uglylink" onclick="return ugly.changePage('/smartspaces/space/${space.id}/view.html', event);">${space.name?html}</a></li>
</#list>
</ul>
<#else>
<p>
