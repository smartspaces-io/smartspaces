...
public class BaseNativeApplicationRunnerListener implements NativeApplicationRunnerListener {
  ...
  @Override
  public void onRestartSuccess(RestartStrategy<NativeApplicationRunner> strategy,
      NativeApplicationRunner restartable) {
    // Default is do nothing
  }

  @Override
  public void onRestartFailure(RestartStrategy<NativeApplicationRunner> strategy,
      NativeApplicationRunner restartable) {
    // Default is do nothing
  }
}
