...
/**
 * A collection of geometrical transformation in 2 dimensions.
 * 
...
public class Transform2 {
  ...
  public Transform2 rotate(double angle) {
    temp.identity().setEntry(0, 0, Math.cos(angle)).setEntry(0, 1, -Math.sin(angle))
        .setEntry(1, 0, Math.sin(angle)).setEntry(1, 1, Math.cos(angle));
