 ...
 */
public class StandardActiveSpaceControllerManager
    implements InternalActiveSpaceControllerManager, RemoteSpaceControllerClientListener {
   ...
   * the live activity.
   */
  private final Multimap<String, ActiveLiveActivity> activeLiveActivitiesByController =
      HashMultimap.create();
  ...
  @Override
  public void statusSpaceController(SpaceController spaceController, boolean force) {
    ...
    if (!SpaceControllerState.UNKNOWN.equals(activeSpaceController.getState()) || force) {
  ...
  public void cleanSpaceControllerTempData(SpaceController spaceController) {
    ...
    try {
      ...
      spaceEnvironment.getLog().formatError(e, "Could not clean space controller temp data: %s",
          activeSpaceController.getDisplayName());
  ...
  public void restoreSpaceControllerDataBundle(SpaceController spaceController) {
    ...
    try {
      ...
      spaceEnvironment.getLog().formatError(e, "Could not restore space controller data bundle: %s",
          activeSpaceController.getDisplayName());
  ...
  private void cleanLiveActivityStateModels(SpaceController spaceController) {
    synchronized (activeLiveActivitiesByController) {
      for (ActiveLiveActivity activeLiveActivity : activeLiveActivitiesByController
          .get(spaceController.getId())) {
  ...
  public void deployActiveLiveActivity(ActiveLiveActivity activeLiveActivity) {
    spaceEnvironment.getLog().formatInfo("Deploying live activity to space controller %s: %s",
  ...
  public void deleteActiveLiveActivity(ActiveLiveActivity activeLiveActivity) {
    spaceEnvironment.getLog().formatInfo("Deleting live activity from space controller %s: %s",
        activeLiveActivity.getActiveController().getDisplayName(),
        activeLiveActivity.getDisplayName());
  ...
  public void configureActiveLiveActivity(ActiveLiveActivity activeLiveActivity) {
    ...
    synchronized (activeLiveActivity) {
      try {
        ...
        spaceEnvironment.getLog().formatError(e, "A live activity has failed to configure: %s",
            activeLiveActivity.getDisplayName());
  ...
  public void startupActiveActivity(ActiveLiveActivity activeLiveActivity) {
    ...
    synchronized (activeLiveActivity) {
      try {
        ...
        spaceEnvironment.getLog().formatError(e, "A live activity has failed to star up: %s",
            activeLiveActivity.getDisplayName());
  ...
  public void deactivateActiveActivity(ActiveLiveActivity activeLiveActivity) {
    ...
    synchronized (activeLiveActivity) {
      try {
        ...
        spaceEnvironment.getLog().formatError(e, "A live activity has failed to deactivate: %s",
            activeLiveActivity.getDisplayName());
  ...
  public void shutdownActiveActivity(ActiveLiveActivity activeLiveActivity) {
    ...
    synchronized (activeLiveActivity) {
      try {
        ...
        spaceEnvironment.getLog().formatError(e, "A live activity has failed to shut down: %s",
            activeLiveActivity.getDisplayName());
  ...
  public void cleanLiveActivityPermanentData(ActiveLiveActivity activeLiveActivity) {
    spaceEnvironment.getLog().formatInfo("Requesting permanent data clean for live activity: %s",
        activeLiveActivity.getDisplayName());
    ...
    synchronized (activeLiveActivity) {
      try {
        ...
        spaceEnvironment.getLog().formatError(e, "Could not clean live activity permanent data: %s",
            activeLiveActivity.getDisplayName());
    ...
    SpaceWalker walker = new SpaceWalker() {
      ...
      protected void doVisit(Space space) {
        for (LiveActivityGroup activityGroup : space.getActivityGroups()) {
          deployActiveLiveActivityGroupChecked(getActiveLiveActivityGroup(activityGroup),
              deployedActivities);
        }
      }
    };
  ...
  public void configureSpace(Space space) {
    ...
    SpaceWalker walker = new SpaceWalker() {
      ...
      protected void doVisit(Space space) {
        for (LiveActivityGroup activityGroup : space.getActivityGroups()) {
          configureActiveLiveActivityGroupChecked(getActiveLiveActivityGroup(activityGroup),
  ...
  public ActiveSpaceController getActiveSpaceController(SpaceController spaceController) {
    ...
    synchronized (activeSpaceControllers) {
      ...
      if (activeController == null) {
        ...
        activeController =
            new ActiveSpaceController(spaceController, spaceEnvironment.getTimeProvider());
  ...
  public ActiveLiveActivityGroup getActiveLiveActivityGroup(LiveActivityGroup liveActivityGroup) {
    synchronized (activeLiveActivityGroups) {
      ActiveLiveActivityGroup activeLiveActivityGroup =
          activeLiveActivityGroups.get(liveActivityGroup.getId());
      if (activeLiveActivityGroup == null) {
        activeLiveActivityGroup = new ActiveLiveActivityGroup(liveActivityGroup);
        activeLiveActivityGroups.put(activeLiveActivityGroup.getActivityGroup().getId(),
            activeLiveActivityGroup);
      } else {
  ...
  public ActiveLiveActivity getActiveLiveActivity(LiveActivity activity) {
    ...
    synchronized (activeLiveActivities) {
      ...
      if (active == null) {
        ...
        active = new ActiveLiveActivity(getActiveSpaceController(spaceController), activity,
            remoteSpaceControllerClient, spaceEnvironment.getTimeProvider());
  ...
  /**
   * Get the active space controller for the given UUID in a thread-friendly
   * way.
   *
   * @param uuid
   *          the UUID of the space controller
   *
   * @return the active space controller associated with the uuid, or
   *         {@code null} if none
   */
  @VisibleForTesting
  ...
  @Override
  public void onSpaceControllerConnectFailed(ActiveSpaceController spaceController,
      long timeToWait) {
    masterEventManager.signalSpaceControllerConnectFailed(spaceController, timeToWait);
  }

  @Override
  public void onSpaceControllerConnect(ActiveSpaceController spaceController, long timestamp) {
    // TODO(keith): Transmit connect event
  }
  ...
  @Override
  public void onSpaceControllerDisconnect(ActiveSpaceController spaceController, long timestamp) {
    // TODO(keith): Transmit disconnect event
  }
  ...
  @Override
  public void onSpaceControllerStatusChange(ActiveSpaceController spaceController,
  ...
  public void onLiveActivityDeployment(String liveActivityUuid,
    ...
    if (active != null) {
      ...
      masterEventManager.signalLiveActivityDeploy(active, result,
          spaceEnvironment.getTimeProvider().getCurrentTime());
    } else {
      logUnknownLiveActivity(liveActivityUuid);
    }
  }
  ...
  @Override
  public void onLiveActivityRuntimeStateChange(String liveActivityUuid, ActivityState newState,
      String newStateDetail) {
    ActiveLiveActivity activeLiveActivity = getActiveActivityByUuid(liveActivityUuid);
   ...
   */
  private void updateLiveActivityStateForCommunicationFailure(ActiveLiveActivity activeLiveActivity,
      Throwable e) {
   ...
   */
  private void updateLiveActivityRuntimeState(ActiveLiveActivity activeLiveActivity,
      ActivityState newState, String newStateDetail) {
    ...
    synchronized (activeLiveActivity) {
      ...
      if (!newState.isRunning() && !newState.isTransitional()) {
        activeLiveActivity.clearRunningStateModel();
      }
    }

    masterEventManager.signalLiveActivityRuntimeStateChange(activeLiveActivity, oldState, newState);
  }

  @Override
  public void onDataBundleStateChange(ActiveSpaceController spaceController,
      DataBundleState state) {
  ...
  /**
   * Log that an unknown live activity gave its status.
   *
   * @param liveActivityUuid
   *          UUID of the unknown live activity
   */
  private void logUnknownLiveActivity(String liveActivityUuid) {
    spaceEnvironment.getLog().formatWarn("Got activity status update for unknown activity %s",
        liveActivityUuid);
  }
   ...
   */
  public void setRemoteActivityDeploymentManager(
