 ...
 *
 * <ul>
 * <li>{@link #onActivityPreSetup()} is called before annotated configuration
 * parameters are processed.</li>
...
public interface SupportedActivity extends Activity {
   ...
   */
  <T extends ActivityComponent> T getRequiredActivityComponent(String componentType)
      throws SmartSpacesException;
