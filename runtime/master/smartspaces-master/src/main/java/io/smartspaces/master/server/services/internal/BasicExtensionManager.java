...
public class BasicExtensionManager implements ExtensionManager {
  ...
  private void initializeBindings() {
    ...
    bindings.put(ScriptingNames.SCRIPTING_NAME_ACTIVE_SPACE_CONTROLLER_MANAGER,
  ...
  private void initializeStartupExtensions() {
    ...
    Set<File> initialFiles =
        startupExtensionsDirectoryWatcher.startupWithScan(spaceEnvironment, DIRECTORY_SCAN_TIME,
            TimeUnit.SECONDS);
