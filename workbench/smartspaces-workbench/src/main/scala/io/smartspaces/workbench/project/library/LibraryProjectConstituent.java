...
public class LibraryProjectConstituent extends BaseProjectConstituent {
  ...
  /**
   * XML entity name for the container package elements in package collection
   * elements.
   */
   ...
   */
  public static final String ATTRIBUTE_VALUE_CONTAINER_PACKAGES_PACKAGE_REQUIRED_VALUE_TRUE =
      "true";

  /**
   * XML attribute value for an container package not being required.
   */
  public static final String ATTRIBUTE_VALUE_CONTAINER_PACKAGES_PACKAGE_REQUIRED_VALUE_FALSE =
      "false";
  ...
  private static class LibraryProjectBuilder extends BaseProjectConstituentBuilder {
    ...
    @Override
    public ProjectConstituent buildConstituentFromElement(Namespace namespace, Element rootElement,
        Project project) {
     ...
     */
    private void extractPrivatePackages(Namespace namespace, Element rootElement,
      ...
      if (packagesElement != null) {
        ...
        List<Element> packageElements =
            packagesElement.getChildren(ELEMENT_NAME_CONTAINER_PACKAGES_PACKAGE, namespace);
     ...
     *          the container info object to store the packages in
     */
    private void extractImportPackages(Namespace namespace, Element rootElement,
        ContainerInfo containerInfo) {
