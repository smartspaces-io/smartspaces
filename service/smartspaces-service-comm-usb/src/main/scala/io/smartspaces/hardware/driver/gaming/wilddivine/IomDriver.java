...
public class IomDriver extends DriverSupport {
  ...
  public static void main(String[] args) {
    ...
    driver.prepare(spaceEnvironment, spaceEnvironment.getSystemConfiguration(),
        spaceEnvironment.getLog());

    driver.addListener(new IomDeviceListener() {

      @Override
      public void onIomMeasurement(IomDriver driver, double heartRateValue,
  ...
  public void startup() {
    ...
    if (endpoint == null) {
      throw new SmartSpacesException("Cannot locate an Iom device on the USB bus");
    }
  ...
  private byte readByte() {
    try {
      ...
      throw new SmartSpacesException("Could not read USB device", e);
    }
  }
}
