...
public class Vector2Tests {
  ...
  public void testNearestPoint() {
    Vector2 answer1 =
        Vector2.nearestPointOnLine(new Vector2(1.0, 1.0), new Vector2(1.0, -1.0), new Vector2(0.0,
            0.0), new Vector2());
  ...
  public void testLineIntersection() {
    Vector2 linePoint = new Vector2(1.0, 1.0);
    Vector2 answer1 =
        Vector2.intersectLines(new Vector2(-1.0, -2.0), new Vector2(2.0, 4.0),
            new Vector2(2.0, 0.0), new Vector2(0.0, 4.0), new Vector2());
