...
package io.smartspaces.util.uuid;
...
public class JavaUuidGenerator implements UuidGenerator {
  ...
  public String newNameUuid(String namespace, String name) {
    ...
    try {
      ...
      // the least significant. position says how far to shift to get the
      // current
      // byte we are interested in aligned with the lower 8 bits that will be
      // written
      // into the output stream. Note it gradually moves from most significant
      // byte to
