...
public class Version implements Comparable<Version> {
   ...
   */
  public static final String VERSION_FORMAT_DESCRIPTION =
      "A version must be of the form major.minor.micro\n"
   ...
   *
   * @return the version represented by the string, or {@code null} if version
   *         was {@code null}
   *
   * @throws SimpleSmartSpacesException
   *           improperly formatted version
   */
  public static Version parseVersionIncludeNull(String version) throws SimpleSmartSpacesException {
  ...
  public static Version parseVersion(String version) throws SimpleSmartSpacesException {
    if (version != null) {
      ...
      throw new SimpleSmartSpacesException("Illegal version null");
    }
  }
