...
public class ActivityProjectConstituent extends BaseProjectConstituent {
  ...
  private static class ActivityProjectBuilder extends BaseProjectConstituentBuilder {
    ...
    public ProjectConstituent buildConstituentFromElement(Namespace namespace,
      ...
      aproject.setActivityType(resourceElement.getAttributeValue(ACTIVITY_TYPE_ATTRIBUTE,
          aproject.getActivityType()));
      aproject.setActivityRuntimeName(getChildTextNormalize(resourceElement, namespace,
          ACTIVITY_NAME_ELEMENT, aproject.getActivityRuntimeName()));
      aproject.setActivityExecutable(getChildTextNormalize(resourceElement, namespace,
          ACTIVITY_EXECUTABLE_ELEMENT, aproject.getActivityExecutable()));
      aproject.setActivityClass(getChildTextNormalize(resourceElement, namespace,
          ACTIVITY_CLASS_ELEMENT, aproject.getActivityClass()));
    ...
    private void processConfigurationPropertyElement(Namespace namespace, Element propertyElement,
      ...
      String description =
          propertyElement.getChildTextNormalize(CONFIGURATION_PROPERTY_DESCRIPTION_ELEMENT,
              namespace);
      String requiredAttribute =
          propertyElement.getAttributeValue(CONFIGURATION_PROPERTY_REQUIRED_ATTRIBUTE);
      ...
      String valueChild =
          propertyElement.getChildTextNormalize(CONFIGURATION_PROPERTY_VALUE, namespace);
