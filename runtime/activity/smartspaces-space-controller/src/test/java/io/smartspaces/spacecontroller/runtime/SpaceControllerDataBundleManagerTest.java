...
public class SpaceControllerDataBundleManagerTest {
  ...
  public void setup() {
    SpaceControllerControl spaceController =
        Mockito.mock(SpaceControllerControl.class, RETURNS_DEEP_STUBS);
    ...
    when(spaceController.getSpaceEnvironment().getFilesystem().getDataDirectory()).thenReturn(
        TEST_DATA_DIRECTORY);
