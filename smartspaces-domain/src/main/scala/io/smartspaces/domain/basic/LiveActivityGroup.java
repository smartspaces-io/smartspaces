 ...
 *
 * <p>
 * The live activities are not necessarily on the controllers at this point. It
 * is assumed they will be at some point before they can be activated.
 *
...
public interface LiveActivityGroup extends PersistedObject, Serializable {
   ...
   * {@link LiveActivityGroupLiveActivityDependencyType#REQUIRED}.
   *
   * @param liveActivity
   ...
   */
  LiveActivityGroup addLiveActivity(LiveActivity liveActivity) throws SmartSpacesException;
