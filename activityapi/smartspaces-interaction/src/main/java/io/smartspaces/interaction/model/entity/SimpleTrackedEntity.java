...
public class SimpleTrackedEntity<T> extends SimplePositionableEntity<T> implements TrackedEntity<T> {
   ...
   *          {@code true} if the entity has been lost
   */
  public SimpleTrackedEntity(String id, T location, boolean stateNew, boolean stateVisible,
      boolean stateLost) {
    super(id, location);
  ...
  public String toString() {
    return "SimpleTrackedEntity [stateNew=" + stateNew + ", stateVisible=" + stateVisible
        + ", stateLost=" + stateLost + ", getId()=" + getId() + ", getPosition()=" + getPosition()
        + "]";
  }
}
