...
package io.smartspaces.activity.component;
...
public class ActivityComponentContext {
   ...
   */
  public ActivityComponentContext(SupportedActivity activity,
  ...
  public boolean waitOnNoProcessingHandlings(long sampleTime, long maxSamplingTime) {
    ...
    while (areProcessingHandlers() && (System.currentTimeMillis() - start) < maxSamplingTime) {
      SmartSpacesUtilities.delay(sampleTime);
    }
   ...
   */
  public <T extends ActivityComponent> T addComponent(T component) throws SmartSpacesException {
   ...
   *           component was already there
   */
  public void addComponents(ActivityComponent... components) throws SmartSpacesException {
   ...
   *           component was already there
   */
  public <T extends ActivityComponent> T addComponent(String componentType)
      throws SmartSpacesException {
   ...
   */
  private void checkIfComponentAdded(String componentName) throws SmartSpacesException {
    ...
    if (addedComponents.containsKey(componentName)) {
      throw new SimpleSmartSpacesException("Multiple activity components added for name "
          + componentName);
    }
  }
  ...
  private void configureComponents() {
    if (!configuredComponents.isEmpty()) {
      throw new SimpleSmartSpacesException("Attempt to configure already configured components");
    }

    DependencyResolver<String, ActivityComponent> resolver =
        new DependencyResolver<String, ActivityComponent>();
  ...
  public <T extends ActivityComponent> T getRequiredActivityComponent(String componentType)
    ...
    if (component == null) {
      throw new SimpleSmartSpacesException("Could not find component " + componentType);
    }
    return component;
  }
