...
public class SimpleNamedVersionedResourceCollectionTest {
  ...
  public void testFindingResource() {
    ...
    Assert.assertEquals(v0Resource,
        collection.getResource("foo", new VersionRange(v0, v0.incrementMajor(), true)));

    Assert.assertNull(collection.getResource("foo",
        new VersionRange(v0.incrementMinor(), v0.incrementMajor(), true)));
  }
