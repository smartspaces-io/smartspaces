...
public class BundleContentProjectConstituent extends BaseContentProjectConstituent {
    ...
    try {
      ...
      for (String sourcePath : sourcePaths) {
        ...
        if (!sourceFile.exists()) {
          throw new SimpleSmartSpacesException("Source file does not exist "
              + sourceFile.getAbsolutePath());
        } else if (sourceFile.isDirectory()) {
          throw new SimpleSmartSpacesException("Source file is a directory "
              + sourceFile.getAbsolutePath());
        }
      ...
      throw new SimpleSmartSpacesException("While processing bundle resource " + outputPath, e);
    } finally {
   ...
   */
  public static class BundleProjectConstituentBuilderFactory implements
