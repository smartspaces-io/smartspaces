...
package io.smartspaces.liveactivity.runtime.activity.wrapper.internal.osnative;

import io.smartspaces.activity.Activity;
import io.smartspaces.activity.impl.binary.NativeActivity;
 ...
 */
public class NativeActivityWrapper extends BaseActivityWrapper {

  @Override
  public Activity newInstance() {
    NativeActivity instance = new NativeActivity();
