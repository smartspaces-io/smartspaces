...
/**
 * A {@link ManagedResource} paired with a {@link Runnable} task that will be
 * run periodically.
 *
...
public class ManagedResourceWithPeriodicTask implements ManagedResource {
   ...
   *          the space environment being run under
   */
  public ManagedResourceWithPeriodicTask(ManagedResource resource, Runnable task, long period,
      TimeUnit unit, SmartSpacesEnvironment spaceEnvironment) {
