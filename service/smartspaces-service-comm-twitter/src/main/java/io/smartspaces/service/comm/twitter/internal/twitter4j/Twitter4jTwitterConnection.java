...
public class Twitter4jTwitterConnection implements TwitterConnection {
  ...
  public void startup() {
    ...
    cb.setDebugEnabled(true).setOAuthConsumerKey(apiKey).setOAuthConsumerSecret(apiKeySecret)
        .setOAuthAccessToken(userAccessToken).setOAuthAccessTokenSecret(userAccessTokenSecret)
        .setUseSSL(true);
  ...
  public String getUser() {
    try {
      ...
      throw new SmartSpacesException("Could not get screen name from Twitter connection", e);
    }
  }
