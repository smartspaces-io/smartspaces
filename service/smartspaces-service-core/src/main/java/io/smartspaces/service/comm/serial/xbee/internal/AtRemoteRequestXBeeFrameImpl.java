 ...
 */
public class AtRemoteRequestXBeeFrameImpl extends BaseRequestXBeeFrame implements
    AtRemoteRequestXBeeFrame {
   ...
   */
  public AtRemoteRequestXBeeFrameImpl(XBeeAddress64 address64, XBeeAddress16 address16,
   ...
   *          options for the frame
   */
  public AtRemoteRequestXBeeFrameImpl(XBeeAddress64 address64, int[] command, int frameNumber,
      int options) {
    this(address64, XBeeAddress16Impl.BROADCAST_ADDRESS, command, frameNumber, options);
  }
}
