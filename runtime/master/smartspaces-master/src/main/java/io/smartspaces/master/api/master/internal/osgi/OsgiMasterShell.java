...
package io.smartspaces.master.api.master.internal.osgi;
...
public class OsgiMasterShell {
  ...
  public void activate() {
    ...
    dict.put(CommandProcessor.COMMAND_SCOPE, "smartspaces");
    dict.put(CommandProcessor.COMMAND_FUNCTION, new String[] { "listActivities", "addActivity",
        "listControllers", "addController", "controllerShutdownallapps", "listLiveActivities",
