 ...
 * and expects those bytes to be written back. The project includes an Arduino
 * sketch which will echo back what it receives on its serial connection.
 * 
 * <p>
...
public class ArduinoEchoActivity extends BaseActivity {
  ...
  public void onActivityActivate() {
    ...
    getLog().info(String.format("Writing %d to the serial connection", valueToSend));
  ...
  private void readStream() {
    ...
    // will get full.
    getLog().info(String.format("Received value %d from the serial connection", value));
  }
}
