...
public class GesturePointable {
   ...
   */
  public GesturePointable(String id, Vector3 tipPosition, Vector3 direction, Vector3 tipVelocity,
      double length, boolean tool) {
    this.id = id;
  ...
  public String toString() {
    return "GesturePointable [id=" + id + ", tipPosition=" + tipPosition + ", direction="
        + direction + ", tipVelocity=" + tipVelocity + ", length=" + length + ", tool=" + tool
        + "]";
  }
}
