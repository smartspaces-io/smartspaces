...
/**
 * Tests for the {@link StandardDynamicObjectNavigator}.
 *
 * @author Keith M. Hughes
 */
public class StandardDynamicObjectNavigatorTest {
  ...
  public void testPrimitives() {
    ...
    StandardDynamicObjectNavigator nav = new StandardDynamicObjectNavigator(root);
  ...
  public void testPaths() {
    ...
    assertEquals(obj2Value, nav.traversePath(String.format("%s.%s.%s", obj1Key, obj2Key, obj2ValueKey)));
    ...
    assertEquals(arrayElement1Value, nav.traversePath(String.format("%s.[1].%s", arrayKey, arrayElement1ValueKey)));
