...
public class SpaceControllerHostIdValidator implements Validator {
   ...
   */
  public static final Pattern HOST_ID_VALIDATION_PATTERN = Pattern.compile("^("
      + HOST_ID_SEGMENT_VALIDATION_REGEX + ")(/" + HOST_ID_SEGMENT_VALIDATION_REGEX + ")*$");

  /**
   * Description of a legal version.
   */
  public static final String HOST_ID_FORMAT_DESCRIPTION =
      "A host must be of the form segment1/segment2/segment3...\n"
