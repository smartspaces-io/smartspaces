...
public final class ActivitySystemConfiguration {
   ...
   * the native platform browser to start up a browser app. Uses
   ...
   * to be handed to the native platform browser to start up a browser app.
   *
   * <p>
  ...
  /**
   * Get the native browser command environment to use according to the activity
   * configuration.
   *
   * @param configuration
   *          the activity configuration
   *
   * @return the full command environment portion of the browser command, can be
   *         {@code null}
   */
