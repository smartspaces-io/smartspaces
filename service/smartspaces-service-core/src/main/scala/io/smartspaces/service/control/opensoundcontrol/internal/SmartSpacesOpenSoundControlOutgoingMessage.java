...
/**
 * An OSC outgoing message for an
 * {@link SmartSpacesUdpOpenSoundControlClientCommunicationsEndpoint}.
 *
 * @author Keith M. Hughes
 */
public class SmartSpacesOpenSoundControlOutgoingMessage implements OpenSoundControlOutgoingMessage {
   ...
   */
  public SmartSpacesOpenSoundControlOutgoingMessage(WriteableUdpPacket message,
      InetSocketAddress remoteAddress, String address, String types) {
   ...
   */
  public SmartSpacesOpenSoundControlOutgoingMessage(WriteableUdpPacket message,
      InetSocketAddress remoteAddress, String address, byte... types) {
