...
public class StandardProjectTaskManager implements ProjectTaskManager {
   ...
   *          the templater to use
   */
  public StandardProjectTaskManager(ProjectTypeRegistry projectTypeRegistry,
   ...
   */
  private ProjectBuildTask addProjectBuildTask(Project project,
      ProjectTaskContext projectTaskContext, WorkbenchTaskContext workbenchTaskContext,
      Map<Project, ProjectBuildTask> existingBuildTasks) {
    ...
    for (ProjectDependency dependency : project.getDependencies()) {
      if (dependency.isDynamic()) {
        ...
        if (dependencyProject != null) {
          ...
          // dependency.
          ProjectTaskContext dependencyProjectTaskContext =
              dependencyBuildTask.getProjectTaskContext();
  ...
  @Override
  public void addDeploymentTasks(String deploymentType, Project project,
      ProjectTaskContext projectTaskContext, WorkbenchTaskContext workbenchTaskContext) {
  ...
  @Override
  public void addIdeProjectTasks(Project project, String ide,
      ProjectTaskContext projectTaskContext, WorkbenchTaskContext workbenchTaskContext) {
  ...
  public class ProjectDeploymentTask extends ProjectWorkbenchTask {
     ...
     */
    public ProjectDeploymentTask(String deploymentType, Project project,
        ProjectTaskContext projectTaskContext) {
        ...
        for (ProjectDeployment deployment : project.getDeployments()) {
          if (deploymentType.equals(deployment.getType())) {
            File deploymentLocation =
                projectTaskContext.getProjectTargetFile(projectTaskContext.getProject()
                    .getBaseDirectory(), deployment.getLocation());
