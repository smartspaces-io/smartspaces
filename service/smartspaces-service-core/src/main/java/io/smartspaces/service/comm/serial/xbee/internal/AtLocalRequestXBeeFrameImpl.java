 ...
 */
public class AtLocalRequestXBeeFrameImpl extends BaseRequestXBeeFrame implements
    AtLocalRequestXBeeFrame {
   ...
   *          the frame number
   */
  public AtLocalRequestXBeeFrameImpl(int[] command, int frameNumber) {
