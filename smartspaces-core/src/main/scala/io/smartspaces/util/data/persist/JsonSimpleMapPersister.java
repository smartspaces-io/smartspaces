...
public class JsonSimpleMapPersister implements SimpleMapPersister {
  ...
  public JsonSimpleMapPersister(File baseMapDirectory) {
    ...
    if (!fileSupport.exists(baseMapDirectory)) {
      if (!fileSupport.mkdirs(baseMapDirectory)) {
        throw new SimpleSmartSpacesException(String.format("Could not create directory %s",
            baseMapDirectory));
      }
    }
  }
  ...
  public Map<String, Object> getMap(String name) {
    ...
    try {
      ...
      throw new SmartSpacesException(String.format("Could not read map %s", name), e);
    } finally {
  ...
  public void putMap(String name, Map<String, Object> map) {
    ...
    try {
      ...
      throw new SmartSpacesException(String.format("Could not write map %s", name), e);
    } finally {
