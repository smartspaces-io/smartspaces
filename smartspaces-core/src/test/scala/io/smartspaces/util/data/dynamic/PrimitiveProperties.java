...
/**
 * Dynamic object interface with primitive properties. Primitive getters (except
 * boolean getters) will throw a {@link NullPointerException} if there's no
 * corresponding value. A boolean getter will return {@code false}.
 *
