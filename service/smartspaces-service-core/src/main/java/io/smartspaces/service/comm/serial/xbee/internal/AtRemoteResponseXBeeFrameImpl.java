...
public class AtRemoteResponseXBeeFrameImpl implements AtRemoteResponseXBeeFrame {
  ...
  public AtRemoteResponseXBeeFrameImpl(int frameId, XBeeAddress64 address64,
      XBeeAddress16 address16, byte[] atCommand, int commandStatus, byte[] commandData) {
  ...
  public String toString() {
    return "AtRemoteResponseXBeeFrameImpl [frameId=" + frameId + ", address64=" + address64
        + ", address16=" + address16 + ", atCommand=" + atCommandString + ", commandStatus="
        + commandStatus + "]";
  }
}
