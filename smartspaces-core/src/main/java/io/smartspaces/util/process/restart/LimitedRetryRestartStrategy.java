...
public class LimitedRetryRestartStrategy<T extends Restartable> extends BaseRestartStrategy<T> {
  ...
  public LimitedRetryRestartStrategy(int numberRetries, long sampleDelay,
      long timeDurationSuccessfulRestart, SmartSpacesEnvironment spaceEnvironment) {
  ...
  public static class LimitedRetryRestartStrategyInstance<U extends Restartable> extends
     ...
     */
    private LimitedRetryRestartStrategyInstance(U restartable,
        LimitedRetryRestartStrategy<U> strategy, int numberRetries, long sampleDelay,
