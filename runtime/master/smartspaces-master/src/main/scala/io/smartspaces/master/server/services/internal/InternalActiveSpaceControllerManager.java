...
public interface InternalActiveSpaceControllerManager extends ActiveSpaceControllerManager {
   ...
   */
  ActiveLiveActivityGroup getActiveLiveActivityGroup(LiveActivityGroup activityGroup);
   ...
   *
   * <p>
   * Live activities in the set will not be deployed. Also, any Live Activities
   * deployed will be added to the set.
   *
   * @param activeLiveActivityGroup
   *          the active activity group to deploy
   ...
   *          {@code null})
   */
  void deployActiveLiveActivityGroupChecked(ActiveLiveActivityGroup activeLiveActivityGroup,
   ...
   *          {@code null})
   */
  void configureActiveLiveActivityGroupChecked(ActiveLiveActivityGroup activeLiveActivityGroup,
