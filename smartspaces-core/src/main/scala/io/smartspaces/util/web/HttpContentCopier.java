...
public interface HttpContentCopier extends ManagedResource {
   ...
   */
  String getContentAsString(String sourceUri) throws SmartSpacesException;
   ...
   *           if transfer was not successful
   */
  String getContentAsString(String sourceUri, Charset charset) throws SmartSpacesException;
   ...
   *           if transfer was not successful
   */
  void copy(String sourceUri, File destination) throws SmartSpacesException;
  ...
  void copyTo(String destinationUri, File source, String sourceParameterName,
      Map<String, String> params) throws SmartSpacesException;
  ...
  void copyTo(String destinationUri, InputStream source, String sourceFileName,
      String sourceParameterName, Map<String, String> params) throws SmartSpacesException;
