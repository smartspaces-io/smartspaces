...
Smart Spaces are physical spaces that can interact with their occupants in some way.

An example can be seen in the picture below.

.. image:: images/SmartSpacesInuse.jpg
...
The Smart Spaces framework is both a collection of libraries for writing activities in
...
activities where Smart Spaces is doing most of the work, but can get as advanced as you
