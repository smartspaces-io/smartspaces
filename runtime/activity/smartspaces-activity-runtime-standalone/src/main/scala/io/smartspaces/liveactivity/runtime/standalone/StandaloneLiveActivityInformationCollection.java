...
public class StandaloneLiveActivityInformationCollection {
   ...
   */
  private Map<String, StandaloneLiveActivityInformation> liveActivityInformation = Maps
      .newHashMap();
   ...
   */
  public StandaloneLiveActivityInformation getLiveActivityInformation(String uuid)
      throws SmartSpacesException {
    ...
    if (info == null) {
      SimpleSmartSpacesException.throwFormattedException(
          "Cannot retrieve live activity with UUID %s", uuid);
    }
