...
public class LimitedRetryRestartStrategyTest {
  ...
  public void testSuccess() throws Exception {
    LimitedRetryRestartStrategy strategy =
        new LimitedRetryRestartStrategy(1, 20, 40, spaceEnvironment);
  ...
  public void testFailure() throws Exception {
    LimitedRetryRestartStrategy strategy =
        new LimitedRetryRestartStrategy(3, 20, 40, spaceEnvironment);
    strategy.addRestartStrategyListener(restartListener);
  ...
  /**
   * The restartable returns false for isrestarted() but the listener vetos the
   * next attempt.
   *
   * @throws Exception
   */
