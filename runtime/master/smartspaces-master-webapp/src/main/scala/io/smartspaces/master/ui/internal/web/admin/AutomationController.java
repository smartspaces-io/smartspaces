...
public class AutomationController extends BaseSpaceMasterController {
  ...
  public @ResponseBody Map<String, ? extends Object> listAllControllersJson(@RequestParam(
  ...
  public @ResponseBody Map<String, ? extends Object> runNamedScript(@PathVariable String id) {
