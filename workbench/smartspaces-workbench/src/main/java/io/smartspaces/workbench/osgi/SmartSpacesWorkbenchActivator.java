...
package io.smartspaces.workbench.osgi;
...
public class SmartSpacesWorkbenchActivator implements BundleActivator {
   ...
   */
  private SimpleSmartSpacesEnvironment spaceEnvironment;
  ...
  public void prepareWorkbenchEnvironment() {
    ...
    spaceEnvironment = new SimpleSmartSpacesEnvironment();
  ...
  /**
   * The bundle is now officially started and the OSGi framework is happy with
   * it.
   */
