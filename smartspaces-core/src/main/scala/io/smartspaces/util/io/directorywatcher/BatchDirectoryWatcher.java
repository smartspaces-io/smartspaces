...
public interface BatchDirectoryWatcher {
   ...
   */
  void startup(SmartSpacesEnvironment environment, long period, TimeUnit unit);
   ...
   */
  Set<File> startupWithScan(SmartSpacesEnvironment environment, long period, TimeUnit unit);
   ...
   */
  void removeBatchDirectoryWatcherListener(BatchDirectoryWatcherListener listener);
