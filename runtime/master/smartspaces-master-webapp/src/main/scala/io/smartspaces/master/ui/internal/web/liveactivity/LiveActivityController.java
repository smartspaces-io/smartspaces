...
public class LiveActivityController extends BaseActiveSpaceMasterController {
  ...
  public @ResponseBody Map<String, ? extends Object> listActivitiesJson(@RequestParam(
  ...
  public @ResponseBody Map<String, ? extends Object> getLiveActivityConfiguration(
  ...
  public @ResponseBody Map<String, ? extends Object> setLiveActivityConfiguration(
  ...
  public @ResponseBody Map<String, ? extends Object> cleanPermanentDataActivity(
      @PathVariable String id) {
