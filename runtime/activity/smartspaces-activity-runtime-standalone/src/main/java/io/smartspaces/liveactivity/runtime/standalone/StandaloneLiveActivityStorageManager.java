...
public class StandaloneLiveActivityStorageManager implements LiveActivityStorageManager {
   ...
   */
  public StandaloneLiveActivityStorageManager(
  ...
  public File getBaseActivityLocation(String uuid) {
    SimpleSmartSpacesException.throwFormattedException(
        "Cannot get base live activity location with UUID %s", uuid);
  ...
  public void removeActivityLocation(String uuid) {
    SimpleSmartSpacesException.throwFormattedException("Cannot delete activities");
  }
