...
public class StandaloneLiveActivityInformation {
  ...
  /**
   * Get the base directory that will be used by the activity runtime for this
   * activity.
   *
   * @return the base directory that will be used by the activity runtime for
   *         this activity
   */
  ...
  /**
   * Set the base directory that will be used by the activity runtime for this
   * activity.
   *
   * @param baseRuntimeActivityDirectory
   *          the base directory that will be used by the activity runtime for
   *          this activity
   */
