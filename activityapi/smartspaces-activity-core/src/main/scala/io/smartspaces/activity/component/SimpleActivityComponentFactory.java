...
public class SimpleActivityComponentFactory implements ActivityComponentFactory {
   ...
   */
  private final Map<String, Class<? extends ActivityComponent>> componentClassMap = Maps
      .newHashMap();
  ...
  public <T extends ActivityComponent> T newComponent(String componentName) {
    ...
    if (componentClass != null) {
      try {
        ...
        throw new SmartSpacesException(String.format("Cannot create activity component %s",
            componentName), e);
      }
    } else {
      throw new SimpleSmartSpacesException(String.format("Unknown activity component %s",
          componentName));
    }
  }
}
