...
public interface SpaceControllerConfigurationManager extends ManagedResource {
  ...
  /**
   * Load the space controller's persisted configuration and modify the
   * configuration in the space environment due to the persisted configuration.
   */
  void load();
   ...
   *
   * <p>
   * This will save it after it is updated. The space environment will also be
   * updated.
   *
   * @param update
