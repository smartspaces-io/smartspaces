...
public class GestureHand {
   ...
   */
  public GestureHand(String id, Vector3 palmPosition, Vector3 palmVelocity, Vector3 palmNormal,
      Vector3 direction, Vector3 sphereCenter, double sphereRadius) {
    this.id = id;
  ...
  public String toString() {
    return "GestureHand [id=" + id + ", direction=" + direction + ", palmPosition=" + palmPosition
        + ", palmVelocity=" + palmVelocity + ", palmNormal=" + palmNormal + ", sphereCenter="
        + sphereCenter + ", sphereRadius=" + sphereRadius + "]";
  }
}
