...
/**
 * Names that objects should have when being scripted.
 *
...
public class ScriptingNames {
   ...
   */
  public static final String SCRIPTING_NAME_MASTER_API_SPACE_CONTROLLER_MANAGER =
   ...
   */
  public static final String SCRIPTING_NAME_MASTER_API_MASTER_SUPPORT_MANAGER =
      "masterApiMasterSupportManager";

  /**
   * The scripting name for the active space controller manager.
   */
  public static final String SCRIPTING_NAME_ACTIVE_SPACE_CONTROLLER_MANAGER =
   ...
   */
  public static final String SCRIPTING_NAME_SPACE_CONTROLLER_REPOSITORY =
