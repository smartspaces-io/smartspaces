...
public class OpenCvCascadeClassifierVideoFrameProcessor extends BaseVideoFrameProcessor<Mat> {
   ...
   */
  private final List<DetectionEventListener<OpenCvVideoLoop, Rectangle2>> listeners = Lists
      .newArrayList();
   ...
   */
  public void
      addDetectionEventListener(DetectionEventListener<OpenCvVideoLoop, Rectangle2> listener) {
   ...
   */
  public void removeDetectionEventListener(
      DetectionEventListener<OpenCvVideoLoop, Rectangle2> listener) {
  ...
  public Mat onNewVideoFrame(Mat frame) {
    ...
    for (Rect detectionRect : classifierDetections.toArray()) {
      ...
      eventData.add(new Rectangle2(topLeft.x, bottomRight.y, bottomRight.x - topLeft.x,
