...
public class NoRestartRestartStrategy<T extends Restartable> extends BaseRestartStrategy<T> {
  ...
  public RestartStrategyInstance<T> newInstance(T restartable) {
    NoRestartRestartStrategyInstance<T> instance =
        new NoRestartRestartStrategyInstance<T>(restartable, this);
   ...
   * @author Keith M. Hughes
   */
  private static class NoRestartRestartStrategyInstance<U extends Restartable> extends
