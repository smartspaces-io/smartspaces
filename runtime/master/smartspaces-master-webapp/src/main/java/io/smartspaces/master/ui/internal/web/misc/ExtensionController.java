...
public class ExtensionController extends BaseSpaceMasterController {
  ...
  public @ResponseBody Map<String, ? extends Object> executeExtension(
      @PathVariable String extensionName, @RequestBody Object argsIn, HttpServletResponse response) {
