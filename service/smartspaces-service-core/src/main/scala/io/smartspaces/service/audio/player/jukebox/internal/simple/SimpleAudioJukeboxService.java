 ...
 */
public class SimpleAudioJukeboxService extends BaseSupportedService implements AudioJukeboxService {

  @Override
  public String getName() {
    return AudioJukeboxService.SERVICE_NAME;
  }
  ...
  public AudioJukebox newAudioJukebox(AudioRepository audioRepository, ExtendedLog log) {
    ...
    return new SimpleAudioJukebox(audioRepository, trackPlayerService.newTrackPlayer(log), log);
  }
}
