...
package io.smartspaces.liveactivity.runtime.repository.internal.file;
  ...
  private SimpleInstalledLiveActivity readDataFile(String uuid) {
    ...
    if (datafile.isFile()) {
      ...
      activity.setInstallationStatus(ActivityInstallationStatus
          .valueOf(lines[LOCATION_INSTALLATION_STATUS]));
      activity.setRuntimeStartupType(ActivityRuntimeStartupType
          .valueOf(lines[LOCATION_STARTUP_TYPE]));
