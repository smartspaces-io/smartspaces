...
public class OsgiDeploymentInstaller implements DeploymentInstaller {
  ...
  public OsgiDeploymentInstaller(BundleContext bundleContext, File deploymentDirectory, Log log) {
  ...
  public DeploymentStatus install(String bundleLocation) {
    try {
      // TODO(keith): Need to copy the bundle into the deploymentDirectory and
      // change
