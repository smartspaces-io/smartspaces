...
/**
 * The live activity configuration manager for a development live activity
 * runtime.
 *
...
public class DevelopmentPropertyFileLiveActivityConfigurationManager extends
   ...
   *          instance suffix to use for the configuration, or {@code null} for
   *          default
   */
  public DevelopmentPropertyFileLiveActivityConfigurationManager(
      ExpressionEvaluatorFactory expressionEvaluatorFactory,
      SmartSpacesEnvironment spaceEnvironment, String instanceSuffix) {
