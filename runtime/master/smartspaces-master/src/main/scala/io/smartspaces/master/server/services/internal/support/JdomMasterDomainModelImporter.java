...
public class JdomMasterDomainModelImporter implements MasterDomainDescription {
  ...
  private SpaceControllerConfiguration getSpaceControllerConfiguration(Element rootElement,
    ...
    Element configurationElement =
        rootElement.getChild(ELEMENT_NAME_SPACE_CONTROLLER_CONFIGURATION);
  ...
  private void getActivity(Element activityElement, ActivityRepository activityRepository,
    ...
    String identifyingName =
        activityElement.getChildTextTrim(ELEMENT_NAME_ACTIVITY_IDENTIFYING_NAME);
    ...
    String lastUploadDateString =
        activityElement.getAttributeValue(ATTRIBUTE_NAME_LAST_UPLOAD_DATE);
    ...
    String bundleContentHash =
        activityElement.getChildTextTrim(ELEMENT_NAME_ACTIVITY_BUNDLE_CONTENT_HASH);
    ...
    if (dependenciesElement != null) {
      ...
      for (Element dependencyElement : dependencyElements) {
        String dependencyName =
            dependencyElement.getChildTextTrim(ELEMENT_NAME_ACTIVITY_DEPENDENCY_NAME);
        ...
        String dependencyRequired =
            dependencyElement.getChildTextTrim(ELEMENT_NAME_ACTIVITY_DEPENDENCY_REQUIRED);
  ...
  private void getLiveActivity(Element liveActivityElement, ActivityRepository activityRepository) {
    ...
    Element mySpaceControllerElement =
        liveActivityElement.getChild(ELEMENT_NAME_LIVE_ACTIVITY_CONTROLLER);
    ...
    ActivityConfiguration configuration =
        getActivityConfiguration(liveActivityElement, activityRepository);
    if (configuration != null) {
      liveActivity.setConfiguration(configuration);
    }

    String lastDeployDateString =
        liveActivityElement.getChildTextTrim(ELEMENT_NAME_LIVE_ACTIVITY_LAST_DEPLOY_DATE);
  ...
  private void getLiveActivityGroupLiveActivities(Element groupElement, LiveActivityGroup group) {
    ...
    if (groupLiveActivitiesElement != null) {
      ...
      for (Element groupLiveActivityElement : groupLiveActivityElements) {
        ...
        LiveActivityGroupLiveActivityDependencyType dependency = LiveActivityGroupLiveActivityDependencyType.valueOf(myDependency);
