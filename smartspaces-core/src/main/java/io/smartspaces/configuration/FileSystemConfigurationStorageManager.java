...
public class FileSystemConfigurationStorageManager implements SystemConfigurationStorageManager {
  ...
  /**
   * The smartspaces file system.
   */
  private SmartSpacesFilesystem smartspacesFilesystem;
  ...
  private File[] getConfigFiles() {
    File configurationFolder =
        new File(configFolder, ContainerFilesystemLayout.FOLDER_CONFIG_smartspaces);
