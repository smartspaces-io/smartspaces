...
import io.smartspaces.util.process.restart.RestartStrategyListener;
 ...
 */
public interface NativeApplicationRunnerListener extends
    RestartStrategyListener<NativeApplicationRunner> {
