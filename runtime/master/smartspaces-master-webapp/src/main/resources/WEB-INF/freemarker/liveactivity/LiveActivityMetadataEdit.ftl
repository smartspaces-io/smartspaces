...
<h1>Edit Live Activity Metadata: ${liveactivity.name?html}</h1>
...
<button type="button" id="cancelButton" onclick="window.location='/smartspaces/liveactivity/${id}/view.html'" title="Cancel the edit">Cancel</button>
</td>
</table>
