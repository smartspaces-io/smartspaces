...
public class SimpleLiveActivityStorageManager implements LiveActivityStorageManager {
   ...
   */
  public SimpleLiveActivityStorageManager(SmartSpacesEnvironment spaceEnvironment) {
  ...
  public InternalLiveActivityFilesystem getActivityFilesystem(String uuid) {
    ...
    SimpleLiveActivityFilesystem activityFilesystem =
        new SimpleLiveActivityFilesystem(baseLocation);
