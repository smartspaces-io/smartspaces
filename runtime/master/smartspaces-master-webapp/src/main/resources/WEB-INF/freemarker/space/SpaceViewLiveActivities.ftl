...
<p><a class="uglylink" onclick="return ugly.changePage('/smartspaces/space/${space.id}/view.html', event);">Back to main space page</a></p>
...
<#list liveActivityGroups as liveActivityGroup>
<tr style="background-color: #e0e0e0; font-weight: bold"><td colspan="3">Live Activity Group: <a class="uglylink" onclick="return ugly.changePage('/smartspaces/liveactivitygroup/${liveActivityGroup.id}/view.html', event);">${liveActivityGroup.name?html}</a></td></tr>
<#list liveActivityGroup.liveActivities as liveactivity>
