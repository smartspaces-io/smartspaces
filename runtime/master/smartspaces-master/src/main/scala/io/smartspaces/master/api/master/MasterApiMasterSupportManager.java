...
public interface MasterApiMasterSupportManager {
   ...
   *
   * <p>
   * The exported model file will be in the root folder of the master in the
   * file named {@link #MASTER_DOMAIN_FILE}.
   *
   * @return the Master API response
   */
   ...
   *
   * <p>
   * The imported model file should be in the root folder of the master in the
   * file named {@link #MASTER_DOMAIN_FILE}.
   *
   * @return the Master API response
   */
