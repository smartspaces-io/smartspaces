...
<h1>Edit Live Activity Group: ${form.liveActivityGroup.name?html}</h1>
...
<button type="button" id="cancelButton" onclick="window.location='/smartspaces/liveactivitygroup/${id}/view.html'" title="Cancel the edit">Cancel</button>
</td>
</table>
