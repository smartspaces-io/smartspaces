 ...
 */
public class ZXingBarcodeHttpGetRequestHandler implements HttpGetRequestHandler {
  ...
  public void handleGetHttpRequest(HttpRequest request, HttpResponse response) {
    ...
    try {
      ...
      throw new SmartSpacesException("Unable to generate barcode message", e);
    }
   ...
   *
   * <p>
   * The default implementation will look at the URL and get the query parameter
   * with name {@link #QUERY_PARAMETER_NAME_CONTENT}.
   *
   * <p>
  ...
  public String getBarcodeContent(HttpRequest request) {
    String barcodeContent = request.getUriQueryParameters().get(QUERY_PARAMETER_NAME_CONTENT);
