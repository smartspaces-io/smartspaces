...
package io.smartspaces.workbench.project.activity.builder.javalang;
...
public class JvmActivityProjectBuilder extends BaseActivityProjectBuilder {
  ...
  public void onBuild(Project project, ProjectTaskContext context, File stagingDirectory)
    ...
    aproject.setActivityExecutable(jarDestinationFile.getName());

    ContainerInfo containerInfo = new ContainerInfo();
    addActivityContainerInformation(aproject, containerInfo);
    ...
    checkForActivityClassExistence(aproject, compilationDirectory);
