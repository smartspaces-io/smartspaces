...
public interface ProjectTaskManager {
   ...
   */
  ProjectTaskContext newProjectTaskContext(Project project,
   ...
   */
  void addPreTasks(Project project, ProjectTaskContext projectTaskContext,
      WorkbenchTaskContext workbenchTaskContext);
   ...
   *          the context for workbench tasks
   */
  void addCleanTasks(Project project, ProjectTaskContext projectTaskContext,
      WorkbenchTaskContext workbenchTaskContext);
   ...
   *          the task context
   */
  void addBuildTasks(Project project, ProjectTaskContext projectTaskContext,
      WorkbenchTaskContext workbenchTaskContext);
   ...
   */
  void addDeploymentTasks(String deploymentType, Project project,
   ...
   *          the task context
   */
  void addDocsTasks(Project project, ProjectTaskContext projectTaskContext,
      WorkbenchTaskContext workbenchTaskContext);
