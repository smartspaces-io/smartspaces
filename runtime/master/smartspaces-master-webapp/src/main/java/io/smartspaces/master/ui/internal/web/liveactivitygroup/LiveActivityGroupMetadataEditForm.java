...
import io.smartspaces.master.ui.internal.web.MetadataEditFormSupport;
...
public class LiveActivityGroupMetadataEditForm extends MetadataEditFormSupport {
  ...
  public String setupForm(@PathVariable("id") String id, Model model) {
    ...
    ConfigurationForm metadataForm = newMetadataForm(liveactivitygroup.getMetadata());
   ...
   */
  private boolean saveMetadataForm(ConfigurationForm form, LiveActivityGroup liveactivitygroup) {
   ...
   */
  private boolean saveMetadata(LiveActivityGroup liveactivitygroup, Map<String, Object> map) {
