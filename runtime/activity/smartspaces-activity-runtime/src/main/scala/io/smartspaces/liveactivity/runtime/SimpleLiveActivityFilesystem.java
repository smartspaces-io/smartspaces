...
public class SimpleLiveActivityFilesystem implements InternalLiveActivityFilesystem {
  ...
  public SimpleLiveActivityFilesystem(File baseInstallationDirectory) {
    this(new File(baseInstallationDirectory, SUBDIRECTORY_INSTALL), new File(
        baseInstallationDirectory, SUBDIRECTORY_LOG), new File(baseInstallationDirectory,
        SUBDIRECTORY_DATA_PERMANENT), new File(baseInstallationDirectory,
        SUBDIRECTORY_DATA_TEMPORARY), new File(baseInstallationDirectory, SUBDIRECTORY_INTERNAL));
  }
   ...
   */
  public SimpleLiveActivityFilesystem(File installDirectory, File logDirectory,
      File permanentDataDirectory, File tempDataDirectory, File internalDirectory) {
  ...
  public void ensureDirectories() {
    ...
    fileSupport.directoryExists(permanentDataDirectory,
