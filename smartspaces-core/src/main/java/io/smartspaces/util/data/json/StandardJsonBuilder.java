...
public class StandardJsonBuilder implements JsonBuilder {
  ...
  public JsonBuilder put(String name, Object value) {
    if (currentType == JsonType.OBJECT) {
      ...
      throw new JsonSmartSpacesException("Cannot put named item into an array");
    }
  ...
  public JsonBuilder putAll(Map<String, Object> data) {
    if (currentType == JsonType.OBJECT) {
      ...
      throw new JsonSmartSpacesException("Cannot put a map of values into an array");
    }
  ...
  public JsonBuilder put(Object value) {
    if (currentType == JsonType.ARRAY) {
      ...
      throw new JsonSmartSpacesException("Cannot put unnamed item into an object");
    }
  ...
  public JsonBuilder up() {
    if (!nav.isEmpty()) {
      ...
      throw new JsonSmartSpacesException("Cannot move up in builder, nothing left");
    }
