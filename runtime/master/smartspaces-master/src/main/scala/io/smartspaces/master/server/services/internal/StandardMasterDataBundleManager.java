...
public abstract class StandardMasterDataBundleManager implements MasterDataBundleManager {
  ...
  public void startup() {
    resourceRepositoryServer.registerResourceUploadListener(
        ResourceRepositoryUploadChannel.DATA_BUNDLE_UPLOAD, new CopyableResourceListener() {
          @Override
  ...
  public void shutdown() {
    resourceRepositoryServer
        .removeResourceUploadListener(ResourceRepositoryUploadChannel.DATA_BUNDLE_UPLOAD);
  }
   ...
   */
  private void
      handleDataBundleUploadSuccess(String controllerUuid, CopyableResource resourceUpload) {
    ...
    try {
      ...
      noException = false;
      throw new SmartSpacesException("Unable to upload bundle for " + controllerUuid, e);
    } finally {
