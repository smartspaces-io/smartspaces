...
package io.smartspaces.service.comm.chat.internal.xmpp.smack;
...
public class SmackXmppChatConnection implements ChatConnection {
  ...
  public SmackXmppChatConnection(String username, String password) {
    this(username, password, CHAT_HOST_DEFAULT, CHAT_PORT_DEFAULT, CHAT_SERVICE_NAME_DEFAULT);
  }

  public SmackXmppChatConnection(String username, String password, String chatHost, int chatPort,
  ...
  public void startup() {
    ConnectionConfiguration config =
        new ConnectionConfiguration(chatHost, chatPort, chatServiceName);
    ...
    try {
      ...
      throw new SmartSpacesException("Could not make XMPP connection", e);
    }
  }
