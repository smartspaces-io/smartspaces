 ...
 */
@Library("NiTE2") 
public class NitePoint3f extends StructObject {
	@Field(0) 
	public float x() {
		return this.io.getFloatField(this, 0);
	}
	@Field(0) 
	public NitePoint3f x(float x) {
	...
	public NitePoint3f(Pointer pointer) {
		super(pointer);
	}
}
