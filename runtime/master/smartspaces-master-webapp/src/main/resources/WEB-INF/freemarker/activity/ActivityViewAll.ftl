...
<table class="commandBar">
  <tr>
    <td><button type="button" id="uploadButton" onclick="ugly.changePage('/smartspaces/activity/upload.html?mode=embedded')" title="Upload an activity">Upload</button></td>
  </tr>
</table>
...
<#list activities as activity>
    ...
    <tr class="${trCss}">
      <td><a class="uglylink" onclick="return ugly.changePage('/smartspaces/activity/${activity.id}/view.html', event);">View</a></td>
