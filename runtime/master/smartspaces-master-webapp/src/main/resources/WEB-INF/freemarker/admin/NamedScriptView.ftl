...
<html>
<head>
<title>Smart Spaces Admin: Scripts</title>
...
function doAjaxCommand(command) {
  $.ajax({
      url: '/smartspaces/admin/namedscript/${script.id}/' + command + '.json',
...
function deleteScript() {
    if (confirm("Are you sure you want to delete the script?")) {
        window.location='/smartspaces/admin/namedscript/${script.id}/delete.html'
    }
}
</script>
...
<table class="commandBar">
  <tr>
    ...
    <td><button type="button" id="editButton" onclick="window.location='/smartspaces/admin/namedscript/${script.id}/edit.html'" title="Edit the script">Edit</button></td>
    <td><button type="button" id="editMetadataButton" onclick="window.location='/smartspaces/admin/namedscript/${script.id}/metadata/edit.html'" title="Edit the named script metadata">Metadata</button></td>
