...
public class InterfaceMapTest {
  ...
  public void getListOfW_maps_ok() {
    ...
    List<Map<String, Object>> list =
        asList(InterfaceMap.getBackingMap(w1), InterfaceMap.getBackingMap(w2));
  ...
  public void equals_equal_returnsTrue() {
    setSomeValues(q);
    setSomeOtherValues(q);
    PossibleProperties other =
        InterfaceMap.createInstance(PossibleProperties.class, new HashMap<String, Object>(map));
  ...
  public void equals_sameStateDifferentTypes_returnsFalse() {
    JavaBeanProperties other =
        InterfaceMap.createInstance(JavaBeanProperties.class, new HashMap<String, Object>(map));
    assertFalse(q.equals(other));
    assertFalse(other.equals(q));
