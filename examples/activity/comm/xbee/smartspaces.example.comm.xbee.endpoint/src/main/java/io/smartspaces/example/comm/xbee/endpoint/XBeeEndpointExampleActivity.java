...
package io.smartspaces.example.comm.xbee.endpoint;
...
/**
 * A simple Smart Spaces Java-based activity which demonstrates using an XBee
 * radio configured as either an endpoint or a router.
 *
 * <p>
