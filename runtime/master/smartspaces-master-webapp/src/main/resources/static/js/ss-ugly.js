...
function SmartSpacesUgly(mainWindow) {
  this.mainWindow = mainWindow;
}

SmartSpacesUgly.prototype = {
  'initialize' : function() {
  ...
  'onWebSocketOpen' : function() {
    console.log("Connected to Smart Spaces master");
  },

  'onWebSocketClose' : function() {
    console.log("Lost connection to Smart Spaces master");
  },
