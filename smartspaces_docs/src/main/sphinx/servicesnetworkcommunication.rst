The Smart Spaces Network Communication Services and Utilities
***************************************

Smart Spaces comes with a variety of services and classes to help with network communication.
Network communication tools can be used for communicating with software applications that do not run
natively in Smart Spaces, or can be used for communicating with hardware.

The Smart Spaces services are easy to use and allow you to let Smart Spaces take care
...
Smart Spaces has services which simplify the creation and usage of TCP-based network servers and clients.
...
Smart Spaces has services which simplify the creation and usage of UDP-based network servers and clients,
...
The Smart Spaces Web Server service allows you to easily create web servers with little or no configuration.
The Smart Spaces Web Server supports
...
The Smart Spaces Web Socket Client Service makes it easy to create Web Socket clients that can communicate
...
during the copy, the call will throw an ``SmartSpacesException``.
...
Smart Spaces has the ability for you to send and receive email from your spaces.

Sending Email
-------------

Smart Spaces has the ability to send email through the Mail Sender Service.
...
Smart Spaces can also receive email through the Email Receiver Service.
...
Smart Spaces includes support for building both Open Sound Control servers and clients. The current implementations
