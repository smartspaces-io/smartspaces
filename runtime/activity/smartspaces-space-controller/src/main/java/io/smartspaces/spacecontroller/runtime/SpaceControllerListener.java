...
import io.smartspaces.container.control.message.activity.SpaceControllerLiveActivityStatuses.ControllerActivityActivateStatus;
import io.smartspaces.container.control.message.activity.SpaceControllerLiveActivityStatuses.ControllerActivityDeactivateStatus;
import io.smartspaces.container.control.message.activity.SpaceControllerLiveActivityStatuses.ControllerActivityDeployStatus;
import io.smartspaces.container.control.message.activity.SpaceControllerLiveActivityStatuses.ControllerActivityShutdownStatus;
