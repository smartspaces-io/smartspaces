 ...
 */
public interface SpaceControllerDataBundleManager extends ManagedResource {
   ...
   */
  void setActivityStorageManager(LiveActivityStorageManager activityStorageManager);
}
