...
<html>
<head>
<title>Smart Spaces Admin: Spaces</title>
...
function doAjaxCommand(command) {
  $.ajax({
      url: '/smartspaces/space/${space.id}/' + command + '.json',
...
function deleteSpace() {
    if (confirm("Are you sure you want to delete the space?")) {
        window.location='/smartspaces/space/${space.id}/delete.html'
    }
}
</script>
...
<table class="commandBar">
  ...
  <tr>
    <td><button type="button" id="liveActivitiesButton" onclick="window.location='/smartspaces/space/${space.id}/liveactivities.html'" title="Get all live activities that are part of the space and its subspaces">Live Activities</button></td>
    <td><button type="button" id="editButton" onclick="window.location='/smartspaces/space/${space.id}/edit.html'" title="Edit the space details">Edit</button></td>
    <td><button type="button" id="editMetadataButton" onclick="window.location='/smartspaces/space/${space.id}/metadata/edit.html'" title="Edit the space metadata">Metadata</button></td>
    <td><button type="button" id="cloneButton" onclick="window.location='/smartspaces/space/${space.id}/clone.html'" title="Clone the space">Clone</button></td>
...
<#list liveActivityGroups as group>
    <li><a class="uglylink" onclick="return ugly.changePage('/smartspaces/liveactivitygroup/${group.id}/view.html', event);">${group.name?html}</a></li>
</#list>
</ul>
<#else>
None
...
<#list subspaces as subspace>
    <li><a class="uglylink" onclick="ugly.changePage('/smartspaces/space/${subspace.id}/view.html')">${subspace.name}</a></li>
</#list>
</ul>
<#else>
None
...
<#list containingSpaces as containingSpace>
    <li><a class="uglylink" onclick="return ugly.changePage('/smartspaces/space/${containingSpace.id}/view.html', event);">${containingSpace.name?html}</a></li>
</#list>
</ul>
<#else>
None
