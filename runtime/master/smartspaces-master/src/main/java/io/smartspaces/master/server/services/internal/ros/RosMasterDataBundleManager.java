...
public class RosMasterDataBundleManager extends StandardMasterDataBundleManager {
  ...
  public void startup() {
    ...
    controllerDataRequestMessageSerializer =
        getMasterNode().getMessageSerializationFactory().newMessageSerializer(
            ControllerDataRequest._TYPE);
  }
   ...
   */
  public void setRosRemoteSpaceControllerClient(
      RosRemoteSpaceControllerClient rosRemoteControllerClient) {
