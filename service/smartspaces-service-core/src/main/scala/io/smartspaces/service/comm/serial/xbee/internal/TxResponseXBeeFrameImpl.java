...
import io.smartspaces.service.comm.serial.xbee.TxResponseXBeeFrame;
...
public class TxResponseXBeeFrameImpl implements TxResponseXBeeFrame {
  ...
  public TxResponseXBeeFrameImpl(int frameId, XBeeAddress16 address16, int transmitRetryCount,
   ...
   * 
   * @see
   * smartspaces.service.comm.serial.xbee.internal.ITxResponseXBeeFrame
   * #getFrameId()
   */
  @Override
  ...
  public String toString() {
    return "TxResponseXBeeFrameImpl [frameId=" + frameId + ", address16=" + address16
        + ", transmitRetryCount=" + transmitRetryCount + ", deliveryStatus=" + deliveryStatus
