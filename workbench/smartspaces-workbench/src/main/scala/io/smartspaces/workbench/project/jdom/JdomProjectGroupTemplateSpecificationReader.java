...
import io.smartspaces.workbench.project.ProjectGroupTemplateSpecificationReader;
import io.smartspaces.workbench.project.creator.TemplateAssignConstituent;
import io.smartspaces.workbench.project.creator.TemplateFileConstituent;
...
public class JdomProjectGroupTemplateSpecificationReader extends JdomReader implements
   ...
   */
  public static final String PROJECT_GROUP_TEMPLATE_SPECIFICATION_ELEMENT_NAME =
   ...
   */
  public JdomProjectGroupTemplateSpecificationReader(SmartSpacesWorkbench workbench) {
    super(workbench);
  ...
  public GroupProjectTemplateSpecification readProjectGroupTemplateSpecification(File specFile) {
    try {
      ...
      throw new SimpleSmartSpacesException("While processing specification file "
          + specFile.getAbsolutePath(), e);
    }
  }
  ...
  private GroupProjectTemplateSpecification makeFromElement(Element rootElement) {
    ...
    GroupProjectTemplateSpecification groupProjectTemplateSpecification =
        new GroupProjectTemplateSpecification();
   ...
   */
  private void addElementToSpec(GroupProjectTemplateSpecification spec, Namespace namespace,
      Element child) {
   ...
   */
  private void processPrototypeChain(GroupProjectTemplateSpecification spec, Namespace namespace,
   ...
   */
  private void configureProjectGroupFromElement(GroupProjectTemplateSpecification spec,
      Namespace namespace, Element projectElement) {
   ...
   */
  private void getSpecificationAttributes(GroupProjectTemplateSpecification spec,
      Element rootElement) {
   ...
   */
  private void getMainData(GroupProjectTemplateSpecification spec, Namespace namespace,
      Element rootElement) {
    spec.setName(getChildTextTrimmed(rootElement, namespace,
        JdomProjectReader.PROJECT_ELEMENT_NAME_NAME, spec.getName()));
    spec.setDescription(getChildTextTrimmed(rootElement, namespace,
        JdomProjectReader.PROJECT_ELEMENT_NAME_DESCRIPTION, spec.getDescription()));

    String version =
        getChildTextTrimmed(rootElement, namespace, JdomProjectReader.PROJECT_ELEMENT_NAME_VERSION);
    if (version != null) {
