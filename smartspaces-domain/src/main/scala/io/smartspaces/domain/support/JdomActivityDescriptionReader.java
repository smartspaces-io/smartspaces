...
public class JdomActivityDescriptionReader implements ActivityDescriptionReader {
   ...
   * dependency.
   */
  public static final String ACTIVITY_ATTRIBUTE_NAME_DEPENDENCY_ITEM_IDENTIFYING_NAME =
      "identifyingName";
   ...
   * required.
   */
  public static final String ACTIVITY_ATTRIBUTE_VALUE_DEFAULT_DEPENDENCY_ITEM_REQUIRED =
      ACTIVITY_VALUE_TRUE;
  ...
  private ActivityDependency getDependency(Element dependencyElement, List<String> errors) {
    String identifyingName =
        dependencyElement
            .getAttributeValue(ACTIVITY_ATTRIBUTE_NAME_DEPENDENCY_ITEM_IDENTIFYING_NAME);
    ...
    String versionStr =
        dependencyElement.getAttributeValue(ACTIVITY_ATTRIBUTE_NAME_DEPENDENCY_ITEM_VERSION);
    if (versionStr != null) {
    ...
    String requiredString =
        dependencyElement.getAttributeValue(
